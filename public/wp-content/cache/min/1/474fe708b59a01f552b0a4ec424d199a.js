  ...
  var _config = {
    ...
    _addToTimeline = function _addToTimeline(timeline, child, position) {
      ...
      if (child._time || (!child._dur && child._initted)) {
        ...
        if (
          !child._dur ||
          _clamp(0, child.totalDuration(), curTime) - child._tTime > _tinyNum
        ) {
    ...
    _onUpdateTotalDuration = function _onUpdateTotalDuration(animation) {
      ...
      animation._tDur = !repeat
        ...
        : repeat < 0
        ? 1e12
        : _round(animation._dur * (repeat + 1) + animation._rDelay * repeat);
    ...
    _parsePosition = function _parsePosition(
      ...
      var labels = animation.labels,
        ...
        clippedDuration =
          animation.duration() >= _bigNum ? recent.endTime(!1) : animation._dur,
        i,
        offset;
    ...
    _proto.totalTime = function totalTime(_totalTime, suppressEvents) {
      ...
      if (parent && parent.smoothChildTiming && this._ts) {
        ...
        this._start =
          ...
          (this._ts > 0
            ? _totalTime / this._ts
            : ((this._dirty ? this.totalDuration() : this._tDur) - _totalTime) /
              -this._ts);
    ...
    _proto.isActive = function isActive(hasStarted) {
      ...
      return !!(
        ...
        (this._ts &&
          ...
          (rawTime = parent.rawTime(!0)) >= start &&
          rawTime < this.endTime(!0) - _tinyNum)
      );
    };
        ...
        if (self._dirty) {
          while (child) {
            ...
            if (child._start < 0 && child._ts) {
              ...
              child._start +
              child._tDur / Math.abs(child._ts || child._pauseTS || _tinyNum);
          ...
          self._end =
            self._start +
            (self._tDur / Math.abs(self._ts || self._pauseTS || _tinyNum) || 0);
          self._dirty = 0;
        }
        return self._tDur;
      }
  ...
  var _addComplexStringPropTween = function _addComplexStringPropTween(
    ...
    _initTween = function _initTween(tween, time) {
      ...
      tween._yEase = yoyoEase
        ? _invertEase(
            _parseEase(yoyoEase === !0 ? ease : yoyoEase, _defaults.ease)
          )
        : 0;
  ...
  var _win$1,
    ...
    _renderCSSPropWithBeginning = function _renderCSSPropWithBeginning(
      ...
      return data.set(
        data.t,
        data.p,
        ratio ? ~~((data.s + data.c * ratio) * 1000) / 1000 + data.u : data.b,
        data
      );
    },
    ...
    _tweenComplexCSSString = function _tweenComplexCSSString(
      ...
      if (!!startValue !== !!endValue) {
        if (startValue) {
          start =
            start.substr(startValue) + " " + start.substr(0, startValue - 1);
        } else {
        ...
        if (specialProp) {
          ...
          if (
            ...
            this._pt = new PropTween(
              ...
              endUnit === "px" && vars.autoRound !== !1 && !isTransformRelated
  ...
  _createClass(FFSlider, [
    {
      ...
      value: function init(ele, param) {
        ...
        if (_this.param.slides_to_show % 2 == 0) {
          console.log(
            'FFSlider: Le paramètre "slides_to_show" dois être un nombre impair, il a été ajusté de "' +
        ...
        if (
          _this.param.fill &&
          (_this.param.show_thumbnails ||
            !_this.param.loop ||
            _this.param.elements_by_slide == 1)
        ) {
          _this.param.fill = !1;
          console.log(
            'FFSlider: Le paramètre "fill=true" ne peut être combiné avec "show_thumbnails=true", "loop=false" ou "elements_by_slide=1". Celui-ci a été désactivé.'
          );
        }
        ...
        if (_this.param.fill) {
          for (
            var index_slide = 0;
            index_slide < _this.param.slides_to_show;
            index_slide++
          ) {
            var html_element = "";
            for (
              var index_element = 0;
              index_element < _this.param.elements_by_slide;
              index_element++
            ) {
              var mathemagic =
                index_slide * _this.param.elements_by_slide +
                index_element -
                index_center * _this.param.elements_by_slide;
            ...
            _this.slider
              ...
              .append(
                '<div class="slide ' +
                  (index_center == index_slide ? "active" : "") +
                  '" >' +
                  html_element +
                  "</div>"
              );
          ...
          for (
            var index_slide = index_center * -1;
            index_slide < _this.param.slides_to_show - index_center;
            index_slide++
          ) {
            _this.slider
              .find(".slides")
              .append(
                '<div class="slide ' +
                  (index_slide == 0 ? "active" : "") +
                  ' " >' +
                  _this.getSlideHtml(_this.getSlideIndex(index_slide)) +
                  "</div>"
              );
          }
        }
    ...
    },
    {
      ...
      value: function getElementIndex(element_index) {
        ...
        element_index =
          element_index -
          parseInt(element_index / _this.total_elements) * _this.total_elements;
    ...
    },
    {
      ...
      value: function getSlideIndex(slide_index) {
        ...
        var mathemagic =
          slide_index -
          parseInt(slide_index / _this.total_slides) * _this.total_slides;
        if (mathemagic < 0) {
    ...
    },
    {
      ...
      value: function getSlideHtml(index_slide) {
        ...
        for (
          var element_index = 0;
          element_index < _this.slides[index_slide].length;
          element_index++
        ) {
        ...
        if (!options.empty) {
          if (_this.param.fill) {
            for (
              ...
              var center =
                (_this.param.elements_by_slide * _this.param.slides_to_show) /
                2;
              var offset = center % _this.param.elements_by_slide;
              var mathemagic =
                _this.current_element_index + index_element + center + offset;
              var element_index = _this.getElementIndex(mathemagic);
              var element = _this.elements.eq(element_index);
            ...
            var slide_index = _this.getSlideIndex(
              _this.current_slide_index + center
            );
    ...
    },
    {
      ...
      value: function goToSlide(slide_index) {
        var _this = this;
        var slide_index_type =
          typeof slide_index == "string" ? "relative" : "absolute";
        ...
        for (var index = 0; index < Math.abs(offset); index++) {
          if (
            !(_this.param.slides_to_show == 1 && index != Math.abs(offset) - 1)
          ) {
          ...
          if (_this.param.fill) {
            _this.current_element_index = _this.getElementIndex(
              _this.current_element_index +
                _this.param.elements_by_slide * direction_value
            );
          } else {
            _this.current_slide_index = _this.getSlideIndex(
              _this.current_slide_index + direction_value
            );
          }
          if (_this.param.after_slide_added != null) {
            _this.param.after_slide_added({
              ...
              slide_added:
                direction == "next"
                  ? _this.slider.find(".slides > .slide").last()
                  : _this.slider.find(".slides > .slide").eq(0),
              direction: direction,
            });
          }
        }
        ...
        if (_this.param.slides_to_show == 1) {
          var next_active_slide = _this.slider.find(
            '.slide:not(".active"):not(".empty")'
          );
        } else {
          var next_active_slide = _this.slider
            .find(".slide")
            .eq(parseInt(_this.slider.find(".slide").length / 2) + offset);
        }
        ...
        if (_this.param.anim_type == "slide") {
          ...
          gsap.to(_this.slider.find(".slides"), _this.param.speed / 1e3, {
            ...
            x:
              slide_width *
              ((_this.param.slides_to_show == 1 ? direction_value : offset) *
                -1),
            onComplete: function onComplete() {
                ...
                if (_this.param.before_slide_removed != null) {
                  ...
                  if (!ele_to_remove.hasClass("empty")) {
                    _this.param.before_slide_removed({
                      ...
                      slide_removed:
                        direction == "next"
                          ? _this.slider.find(".slide").eq(0)
                          : _this.slider.find(".slide").last(),
                      direction: direction,
                    });
                  }
                }
              ...
              gsap.set(_this.slider.find(".slides"), { x: "0" });
              _this.unlockNav();
...
function scrollToFF(e, t, n, i) {
  ...
  if (
    ...
    return (
      ...
      $("html,body")
        .stop()
        .animate({ scrollTop: o }, t, function () {
...
function creationSlider(e, t, n, i, r, o, a, s, l, u, c, d) {
  var h = e;
  if (
    ((tabGlobal[h] = new Array()),
    (tabGlobal[h].id = e),
    (tabGlobal[h].vitesseSlider = t),
    (tabGlobal[h].maxContenuSlider = $(e + " .contenu").children().length),
    (tabGlobal[h].indexSlider = u),
    (tabGlobal[h].easingSlider = i),
    (tabGlobal[h].stopSurPlay = o),
    (tabGlobal[h].ciblefctDebut = a),
    (tabGlobal[h].ciblefctFin = s),
    (tabGlobal[h].setCss = l),
    (tabGlobal[h].typeAnim = c),
    (tabGlobal[h].duree = n),
    (tabGlobal[h].animationEnCours = !1),
    (tabGlobal[h].swipeMobile = "swipeMobile" == d),
    tabGlobal[h].maxContenuSlider <= 1)
  )
    r = !1;
  1 == r &&
    (tabGlobal[h].intervalSlider = setInterval(function () {
      ("#slider-lookbook" == h && 0 != $("#slider-lookbook a.hover").length) ||
        (desactiverFleche(h),
        tabGlobal[h].indexSlider++,
        tabGlobal[h].indexSlider >= tabGlobal[h].maxContenuSlider &&
          (tabGlobal[h].indexSlider = 0),
        imageSuivante(h));
    }, n)),
    $(tabGlobal[h].id + " .contenu").hide(),
    $(tabGlobal[h].id + " .mask").css("overflow", "hidden"),
    $(tabGlobal[h].id + " .mask").css("height", "100%"),
    $(tabGlobal[h].id + " .conteneur").css("position", "absolute"),
    $(tabGlobal[h].id + " .conteneur").css("top", "0"),
    $(tabGlobal[h].id + " .conteneur").css("left", "0"),
    tabGlobal[h].maxContenuSlider <= 1
      ? $(tabGlobal[h].id + " .thumbs").css("display", "none")
      : ($(tabGlobal[h].id + " .thumbs").css("-moz-user-select", "none"),
        $(tabGlobal[h].id + " .thumbs").css("-khtml-user-select", "none"),
        $(tabGlobal[h].id + " .thumbs").css("-webkit-user-select", "none")),
    resizeSlider(h),
...
function activerFleche(e) {
  ...
  $(tabGlobal[t].id + " .flecheGauche").click(function () {
    (fleche = "gauche"),
      tabGlobal[t].stopSurPlay
        ? clearInterval(tabGlobal[t].intervalSlider)
        : (clearInterval(tabGlobal[t].intervalSlider),
          (tabGlobal[t].intervalSlider = 0),
          (tabGlobal[t].intervalSlider = ""),
          (tabGlobal[t].intervalSlider = setInterval(function () {
            desactiverFleche(t),
              tabGlobal[t].indexSlider++,
              tabGlobal[t].indexSlider >= tabGlobal[t].maxContenuSlider &&
                (tabGlobal[t].indexSlider = 0),
              imageSuivante(t);
          }, tabGlobal[t].duree))),
      desactiverFleche(t),
      tabGlobal[t].indexSlider--,
      tabGlobal[t].indexSlider < 0 &&
        (tabGlobal[t].indexSlider = tabGlobal[t].maxContenuSlider - 1),
      imagePrecedante(t);
  }),
    ...
    $(tabGlobal[t].id + " .thumbs a").click(function () {
      ...
      var e = $(this).index();
      e == tabGlobal[t].indexSlider ||
        (e < tabGlobal[t].indexSlider
          ? (desactiverFleche(t),
            (tabGlobal[t].indexSlider = e),
            imagePrecedante(t))
          : e > tabGlobal[t].indexSlider &&
            (desactiverFleche(t),
            (tabGlobal[t].indexSlider = e),
    ...
    tabGlobal[t].swipeMobile &&
      isMobile &&
      $(tabGlobal[t].id).swipe({
        swipeLeft: function (e, n, i, r, o) {
          tabGlobal[t].animationEnCours ||
            ($(window).width() < 1200 &&
              ("left" == n
                ? (tabGlobal[t].stopSurPlay
                    ? clearInterval(tabGlobal[t].intervalSlider)
                ...
                : "right" == n &&
                  ...
                  tabGlobal[t].indexSlider < 0 &&
                    (tabGlobal[t].indexSlider =
                      tabGlobal[t].maxContenuSlider - 1),
                  imagePrecedante(t))));
        },
...
function desactiverFleche(e) {
  var t = e;
  (tabGlobal[t].animationEnCours = !0),
    $(tabGlobal[t].id + " .flecheDroite").unbind("click"),
    $(tabGlobal[t].id + " .flecheGauche").unbind("click"),
    $(tabGlobal[t].id + " .thumbs a").unbind("click");
}
function resizeSlider(e) {
  var t = e,
    n = $(tabGlobal[t].id).width(),
    i = $(tabGlobal[t].id).height();
  $(tabGlobal[t].id + " .conteneur").css("width", n + "px"),
    $(tabGlobal[t].id + " .conteneur").css("height", i + "px"),
    $(tabGlobal[t].id + " .temp").css("width", n + "px"),
    $(tabGlobal[t].id + " .temp").css("height", i + "px");
}
function imagePrecedante(pSid) {
  var sID = pSid;
  $(tabGlobal[sID].id + " .thumbs a").removeClass("actif"),
    $(tabGlobal[sID].id + " .thumbs a")
      .eq(tabGlobal[sID].indexSlider)
      .addClass("actif"),
    $(document).ready(function () {
      eval(tabGlobal[sID].ciblefctDebut);
    }),
    "fade" == tabGlobal[sID].typeAnim
      ? $(tabGlobal[sID].id)
          .find(".mask")
          .append(
            '<div class="temp conteneurCSS" style="z-index:100; position:absolute; left:0px; top:0;opacity:0" >' +
              $(tabGlobal[sID].id + " .contenu > div")
                .eq(tabGlobal[sID].indexSlider)
                .html() +
              "</div>"
          )
      : "crossFade" == tabGlobal[sID].typeAnim
      ? $(tabGlobal[sID].id)
          .find(".mask")
          .append(
            '<div class="temp conteneurCSS" style="z-index:100; position:absolute; left:0px; top:0;opacity:0" >' +
      ...
      : "swipeLeft" == tabGlobal[sID].typeAnim ||
        "swipeRight" == tabGlobal[sID].typeAnim
      ? $(tabGlobal[sID].id)
          .find(".mask")
          .prepend(
            '<div class="temp conteneurCSS" style="position:absolute; left:0px; top:0;" >' +
              $(tabGlobal[sID].id + " .contenu > div")
                .eq(tabGlobal[sID].indexSlider)
                .html() +
              "</div>"
          )
      : "custom" == tabGlobal[sID].typeAnim
      ? $(tabGlobal[sID].id)
          .find(".mask")
          .append(
            '<div class="temp conteneurCSS" style="z-index:100; position:absolute; left:0px; top:0;opacity:0" >' +
      ...
      : $(tabGlobal[sID].id)
          .find(".mask")
          .prepend(
            '<div class="temp conteneurCSS" style="position:absolute; left:-' +
              $(tabGlobal[sID].id).width() +
              'px; top:0;" >' +
              $(tabGlobal[sID].id + " .contenu > div")
                .eq(tabGlobal[sID].indexSlider)
                .html() +
    ...
    "fade" == tabGlobal[sID].typeAnim
      ? $(tabGlobal[sID].id + " .temp").animate(
          { opacity: "1" },
          tabGlobal[sID].vitesseSlider,
          tabGlobal[sID].easingSlider,
          function () {
            chargerContenuSlider(sID);
          }
        )
      : "crossFade" == tabGlobal[sID].typeAnim
      ? ($(tabGlobal[sID].id + " .conteneur").animate(
          { opacity: "0" },
          tabGlobal[sID].vitesseSlider,
          tabGlobal[sID].easingSlider
        ),
      ...
      : "custom" == tabGlobal[sID].typeAnim
      ? setTimeout(function () {
          $(tabGlobal[sID].id + " .conteneur").css(
            "left",
            "-" + $(tabGlobal[sID].id).width() + "px"
          ),
            $(tabGlobal[sID].id + " .temp").css("left", "0px"),
            $(tabGlobal[sID].id + " .temp").css("opacity", "1"),
            chargerContenuSlider(sID);
        }, tabGlobal[sID].vitesseSlider)
      : ($(tabGlobal[sID].id + " .conteneur").animate(
          { left: $(tabGlobal[sID].id).width() + "px" },
...
function chargerContenuSlider(pSid) {
  ...
  $(tabGlobal[sID].id + " .thumbs a")
    .eq(tabGlobal[sID].indexSlider)
    .addClass("actif"),
    0 == $(tabGlobal[sID].id + " .temp").length
      ? $(tabGlobal[sID].id + " .conteneur").html(
          $(tabGlobal[sID].id + " .contenu > div")
            .eq(tabGlobal[sID].indexSlider)
            .html()
        )
      : ($(tabGlobal[sID].id + " .temp")
          .addClass("conteneurTemp")
          .removeClass("temp"),
        $(tabGlobal[sID].id + " .conteneur").remove(),
        $(tabGlobal[sID].id + " .conteneurTemp")
          .addClass("conteneur")
          .removeClass("conteneurTemp")),
    (tabGlobal[sID].animationEnCours = !1),
    activerFleche(sID),
    $(document).ready(function () {
...
function deplacerSlider(e, t) {
  var n = e;
  tabGlobal[n].stopSurPlay
    ? clearInterval(tabGlobal[n].intervalSlider)
    : (clearInterval(tabGlobal[n].intervalSlider),
      (tabGlobal[n].intervalSlider = 0),
      (tabGlobal[n].intervalSlider = ""),
      (tabGlobal[n].intervalSlider = setInterval(function () {
        desactiverFleche(n),
          tabGlobal[n].indexSlider++,
          tabGlobal[n].indexSlider >= tabGlobal[n].maxContenuSlider &&
            (tabGlobal[n].indexSlider = 0),
          imageSuivante(n);
      }, tabGlobal[n].duree)));
  var i = t;
  i == tabGlobal[n].indexSlider ||
    (i < tabGlobal[n].indexSlider
      ? (desactiverFleche(n),
        (tabGlobal[n].indexSlider = i),
        imagePrecedante(n))
      : i > tabGlobal[n].indexSlider &&
        (desactiverFleche(n),
        (tabGlobal[n].indexSlider = i),
...
!(function (e, t) {
  ...
  function n(e, t, n) {
    var i,
      r = (t = t || Z).createElement("script");
    if (((r.text = e), n)) for (i in pe) n[i] && (r[i] = n[i]);
    ...
    return (
      (n =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && o(e, t)) ? fe.merge([e], n) : n
    );
  }
  function w(e, t) {
  ...
  function k(e, t, n, r, o) {
        ...
        if ("object" === i(a)) fe.merge(p, a.nodeType ? [a] : a);
          ...
          for (
            s = s || h.appendChild(t.createElement("div")),
              ...
              u = We[l] || We._default,
              s.innerHTML = u[1] + fe.htmlPrefilter(a) + u[2],
              d = u[0];
            d--;
    ...
    for (h.textContent = "", f = 0; (a = p[f++]); )
      if (r && fe.inArray(a, r) > -1) o && o.push(a);
        ...
        ((c = fe.contains(a.ownerDocument, a)),
  ...
  function I(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Ne.hasData(e) &&
        ((o = Ne.access(e)), (a = Ne.set(t, o)), (u = o.events))
      ) {
      ...
      Ge.hasData(e) &&
        ((s = Ge.access(e)), (l = fe.extend({}, s)), Ge.set(t, l));
    }
  }
  function D(e, t) {
  ...
  function L(e, t, i, r) {
    ...
    var o,
      ...
      f = t[0],
      m = de(f);
    if (m || (h > 1 && "string" == typeof f && !ce.checkClone && Ze.test(f)))
    ...
    if (
      h &&
      ((o = k(t, e[0].ownerDocument, !1, e, r)),
      (a = o.firstChild),
      1 === o.childNodes.length && (o = a),
      a || r)
    ) {
      for (l = (s = fe.map(y(o, "script"), E)).length; d < h; d++)
        (u = o),
          d !== p &&
            ((u = fe.clone(u, !0, !0)), l && fe.merge(s, y(u, "script"))),
          i.call(e[d], u, d);
      if (l)
        for (c = s[s.length - 1].ownerDocument, fe.map(s, A), d = 0; d < l; d++)
          (u = s[d]),
            Ve.test(u.type || "") &&
              !Ne.access(u, "globalEval") &&
              fe.contains(c, u) &&
              (u.src && "module" !== (u.type || "").toLowerCase()
                ? fe._evalUrl && fe._evalUrl(u.src)
                : n(u.textContent.replace(et, ""), c, u));
    }
    return e;
  }
  function N(e, t, n) {
    for (var i, r = t ? fe.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || fe.cleanData(y(i)),
        i.parentNode &&
          (n && fe.contains(i.ownerDocument, i) && w(y(i, "script")),
  ...
  function F(e, t, n, i, r, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (l += fe.css(e, n + je[a], !0, r)),
        i
          ? ("content" === n && (l -= fe.css(e, "padding" + je[a], !0, r)),
            "margin" !== n &&
              (l -= fe.css(e, "border" + je[a] + "Width", !0, r)))
          : ((l += fe.css(e, "padding" + je[a], !0, r)),
            "padding" !== n
              ? (l += fe.css(e, "border" + je[a] + "Width", !0, r))
              : (s += fe.css(e, "border" + je[a] + "Width", !0, r)));
    return (
      !i &&
        o >= 0 &&
        (l += Math.max(
  ...
  function j(e, t, n) {
    ...
    return (
      (a = a && (ce.boxSizingReliable() || r === e.style[t])),
      ("auto" === r ||
        (!parseFloat(r) && "inline" === fe.css(e, "display", !1, i))) &&
  ...
  function $(e, t) {
    ...
    for (t = t ? 1 : 0; i < 4; i += 2 - t)
      r["margin" + (n = je[i])] = r["padding" + n] = e;
    return t && (r.opacity = r.width = e), r;
  }
  function B(e, t, n) {
    for (
      var i,
        r = (V.tweeners[t] || []).concat(V.tweeners["*"]),
        o = 0,
        a = r.length;
      o < a;
      o++
  ...
  function V(e, t, n) {
    ...
    for (
      ...
      if ((i = V.prefilters[o].call(u, e, c, u.opts)))
        return (
          de(i.stop) &&
            (fe._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)),
          i
        );
    return (
      fe.map(c, B, u),
  ...
  var ge = (function (e) {
    function t(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : q) !== N && L(t), (t = t || N), _)
      ) {
        if (11 !== f && (l = ge.exec(e)))
          if ((r = l[1])) {
            if (9 === f) {
            ...
            } else if (h && (a = h.getElementById(r)) && j(t, a) && a.id === r)
              return n.push(a), n;
          } else {
      ...
      return (
        ...
        i(function (i, s, l, u) {
          var c,
            ...
            y = r ? (a || (i ? e : m || o) ? [] : s) : b;
          if ((r && r(b, y, l, u), o))
            for (c = g(y, f), o(c, [], l, u), d = c.length; d--; )
              (h = c[d]) && (y[f[d]] = !(b[f[d]] = h));
          if (i) {
            if (a || e) {
              if (a) {
      ...
      var r = n.length > 0,
        ...
        a = function (i, a, s, l, u) {
          ...
          for (
            ...
            if (o && c) {
              for (
                d = 0, a || c.ownerDocument === N || (L(c), (s = !_));
                (h = e[d++]);
    ...
    try {
      Q.apply((z = J.call(q.childNodes)), q.childNodes),
    ...
    (k = t.support = {}),
      ...
      (L = t.setDocument = function (e) {
        ...
        return i !== N && 9 === i.nodeType && i.documentElement
          ? ((N = i),
            ...
            (k.getElementsByClassName = me.test(N.getElementsByClassName)),
            (k.getById = r(function (e) {
              return (
                (G.appendChild(e).id = R),
            ...
            (O = []),
            (M = []),
            (k.qsa = me.test(N.querySelectorAll)) &&
              (r(function (e) {
            ...
            (t = me.test(G.compareDocumentPosition)),
            (j =
              t || me.test(G.contains)
                ? function (e, t) {
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!k.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === N || (e.ownerDocument === q && j(q, e))
                        ? -1
                        : t === N || (t.ownerDocument === q && j(q, t))
                        ? 1
                        : I
                        ? Z(I, e) - Z(I, t)
                        : 0
      ...
      (t.uniqueSort = function (e) {
        var t,
          ...
          r = 0;
        if (
          ((D = !k.detectDuplicates),
          (I = !k.sortStable && e.slice(0)),
          e.sort(U),
          D)
        ) {
                    ...
                    if (((f = [a ? g.firstChild : g.lastChild]), a && b)) {
                      ...
                      (b &&
                        (y = p =
                          (u =
                            (c =
                              (d = (h = t)[R] || (h[R] = {}))[h.uniqueID] ||
                              (d[h.uniqueID] = {}))[e] || [])[0] === H && u[1]),
                      !1 === y)
                    )
                      for (
                        ;
    ...
    return (
      ...
      (E = t.select = function (e, t, n, i) {
        ...
        if (((n = n || []), 1 === c.length)) {
          if (
            ...
            if (!(t = (T.find.ID(a.matches[0].replace(be, ye), t) || [])[0]))
              return n;
      ...
      (k.sortStable = R.split("").sort(U).join("") === R),
      (k.detectDuplicates = !!D),
      L(),
  ...
  (fe.filter = function (e, t, n) {
    ...
    fe.fn.extend({
      ...
      is: function (e) {
        return !!a(
          this,
          "string" == typeof e && ye.test(e) ? fe(e) : e || [],
          !1
        ).length;
      },
    });
    ...
    if (((n = n || ke), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          fe.merge(
            this,
            fe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : Z, !0)
          ),
      ...
      return (
        (r = Z.getElementById(i[2])) && ((this[0] = r), (this.length = 1)), this
      );
    }
    return e.nodeType
      ...
      function (e, t) {
        fe.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (Se[e] || fe.uniqueSort(r), xe.test(e) && r.reverse()),
            this.pushStack(r)
          );
        };
      }
    ...
    e =
      "string" == typeof e
        ? (function (e) {
            var t = {};
            return (
              fe.each(e.match(Ce) || [], function (e, n) {
                t[n] = !0;
              }),
              t
            );
    ...
    fe.extend({
        ...
        var n = [
          ...
          r = {
            ...
            then: function (t, i, r) {
                ...
                return function () {
                      ...
                      : function () {
                          try {
                            ...
                            fe.Deferred.exceptionHook &&
                              fe.Deferred.exceptionHook(e, h.stackTrace),
                              t + 1 >= a &&
                                (i !== u && ((s = void 0), (c = [e])),
                                n.rejectWith(s, c));
                          }
                  ...
                  t
                    ...
                    : (fe.Deferred.getStackHook &&
                        (h.stackTrace = fe.Deferred.getStackHook()),
                      e.setTimeout(h));
                };
              }
              var a = 0;
              return fe
                .Deferred(function (e) {
                  n[0][3].add(o(0, e, de(r) ? r : l, e.notifyWith)),
                    n[1][3].add(o(0, e, de(t) ? t : l)),
                    n[2][3].add(o(0, e, de(i) ? i : u));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          ...
          "pending" === o.state() || de(r[n] && r[n].then))
        )
          return o.then();
    ...
    fe.extend({
      ...
      ready: function (e) {
        (!0 === e ? --fe.readyWait : fe.isReady) ||
          ((fe.isReady = !0),
          (!0 !== e && --fe.readyWait > 0) || Ee.resolveWith(Z, [fe]));
      },
    }),
    (fe.ready.then = Ee.then),
    ...
    fe.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((r = Ge.get(o)), 1 === o.nodeType && !Ne.get(o, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                0 === (i = a[n].name).indexOf("data-") &&
                ((i = p(i.slice(5))), m(o, i, r[i]));
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!i || Array.isArray(n)
                ? (i = Ne.access(e, t, fe.makeArray(n)))
                : i.push(n)),
            i || []
          );
      },
  ...
  (fe.event = {
      ...
      if (g)
        for (
          n.handler && ((n = (o = n).handler), (r = o.selector)),
            r && fe.find.matchesSelector(Xe, r),
          ...
          if (
            ...
            a &&
              ...
              ((d.teardown && !1 !== d.teardown.call(e, f, g.handle)) ||
                fe.removeEvent(e, p, g.handle),
              delete l[p]);
          } else for (p in l) fe.event.remove(e, p + t[u], n, i, !0);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = fe.event.handlers.call(this, s, u), t = 0;
  ...
  fe.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (o = o || y(e), a = a || y(s), i = 0, r = o.length; i < r; i++)
            I(o[i], a[i]);
        else I(e, s);
      ...
      replaceWith: function () {
        ...
        return L(
          ...
          function (t) {
            ...
            fe.inArray(this, e) < 0 &&
              (fe.cleanData(y(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    fe.each(
      ...
      function (e, t) {
        fe.fn[e] = function (e) {
          for (var n, i = [], r = fe(e), o = r.length - 1, a = 0; a <= o; a++)
    ...
    function t() {
      if (u) {
        (l.style.cssText =
          ...
          Xe.appendChild(l).appendChild(u);
  ...
  fe.extend({
    ...
    fe.each(["height", "width"], function (e, t) {
      fe.cssHooks[t] = {
        get: function (e, n, i) {
          if (n)
            return !rt.test(fe.css(e, "display")) ||
        ...
        return Ae(
          ...
          function (e, t, n) {
            var i,
              ...
              a = 0;
            if (Array.isArray(t)) {
              for (i = nt(e), r = t.length; a < r; a++)
                o[t[a]] = fe.css(e, t[a], !1, i);
              return o;
            }
      ...
      function (e, t, n) {
        ...
        if ((l = !fe.isEmptyObject(t)) || !fe.isEmptyObject(p)) {
          d &&
            ...
            null == (u = g && g.display) && (u = Ne.get(e, "display")),
          ...
          for (i in p)
            l ||
              (g
                ...
                : (g = Ne.access(e, "fxshow", { display: u })),
              o && (g.hidden = !m),
              m && b([e], !0),
              h.done(function () {
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && fe.isXMLDoc(e)) ||
                (r =
                  ...
                  (fe.expr.match.bool.test(t) ? ft : void 0)),
              void 0 !== n
                ? null === n
    ...
    fe.fn.extend({
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              var t, r, o, a;
              if (i)
                for (r = 0, o = fe(this), a = X(e); (t = a[r++]); )
                  o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = U(this)) && Ne.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = " " + e + " "; (n = this[i++]); )
          if (1 === n.nodeType && (" " + W(U(n)) + " ").indexOf(t) > -1)
            return !0;
        return !1;
      },
    });
    ...
    fe.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, i, r = e.options, o = fe.makeArray(t), a = r.length;
              a--;

            )
              ((i = r[a]).selected =
                fe.inArray(fe.valHooks.option.get(i), o) > -1) && (n = !0);
  ...
  fe.extend(fe.event, {
    trigger: function (t, n, i, r) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !yt.test(f + fe.event.triggered) &&
          (f.indexOf(".") > -1 && ((f = (m = f.split(".")).shift()), m.sort()),
          (u = f.indexOf(":") < 0 && "on" + f),
        ...
        if (!r && !d.noBubble && !he(i)) {
          for (
            l = d.delegateType || f, yt.test(l + f) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            p.push(a), (s = a);
        ...
        for (o = 0; (a = p[o++]) && !t.isPropagationStopped(); )
          (h = a),
            ...
            (c = (Ne.get(a, "events") || {})[t.type] && Ne.get(a, "handle")) &&
              c.apply(a, n),
            (c = u && a[u]) &&
              c.apply &&
              Le(a) &&
        ...
        return (
          ...
          r ||
            ...
            (u &&
              ...
              t.isPropagationStopped() && h.addEventListener(f, wt),
              i[f](),
              t.isPropagationStopped() && h.removeEventListener(f, wt),
    ...
    fe.extend({
      ...
      ajax: function (t, n) {
            ...
            u
              ? (f.ifModified &&
                  ((k = x.getResponseHeader("Last-Modified")) &&
                    (fe.lastModified[o] = k),
                  (k = x.getResponseHeader("etag")) && (fe.etag[o] = k)),
                204 === t || "HEAD" === f.type
                  ? (T = "nocontent")
                  : 304 === t
                  ? (T = "notmodified")
                  : ((T = w.state), (h = w.data), (u = !(p = w.error))))
              : ((p = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
            (x.status = t),
            (x.statusText = (n || T) + ""),
            u ? v.resolveWith(m, [h, T, x]) : v.rejectWith(m, [x, T, p]),
            x.statusCode(y),
            (y = void 0),
            d && g.trigger(u ? "ajaxSuccess" : "ajaxError", [x, f, u ? h : p]),
            b.fireWith(m, [x, T]),
            d &&
        ...
        (d = fe.event && f.global) &&
          ...
          f.ifModified &&
            (fe.lastModified[o] &&
              x.setRequestHeader("If-Modified-Since", fe.lastModified[o]),
            fe.etag[o] && x.setRequestHeader("If-None-Match", fe.etag[o])),
        ...
        if (
          ...
          if (((x.readyState = 1), d && g.trigger("ajaxSend", [x, f]), c))
            return x;
          f.async &&
            f.timeout > 0 &&
  ...
  fe.ajaxSetup({
    ...
    fe.ajaxPrefilter("json jsonp", function (t, n, i) {
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          (r = t.jsonpCallback = de(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
      ...
      return (
        t ||
          (ce.createHTMLDocument
            ? (((i = (t = Z.implementation.createHTMLDocument(
                ""
              )).createElement("base")).href = Z.location.href),
    ...
    (fe.fn.load = function (e, t, n) {
      var i,
        ...
        s = e.indexOf(" ");
      return (
        s > -1 && ((i = W(e.slice(s))), (e = e.slice(0, s))),
        de(t)
          ? ((n = t), (t = void 0))
        ...
        if (this[0]) {
          ...
          if ("fixed" === fe.css(i, "position")) t = i.getBoundingClientRect();
            ...
            e &&
              e !== i &&
              1 === e.nodeType &&
              (((r = fe(e).offset()).top += fe.css(e, "borderTopWidth", !0)),
              (r.left += fe.css(e, "borderLeftWidth", !0)));
          }
          return {
    ...
    fe.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (
      e,
      t
    ) {
      var n = "pageYOffset" === t;
    ...
    fe.each(["top", "left"], function (e, t) {
      fe.cssHooks[t] = _(ce.pixelPosition, function (e, n) {
        if (n)
          return (n = G(e, t)), tt.test(n) ? fe(e).position()[t] + "px" : n;
      });
    }),
    fe.each({ Height: "height", Width: "width" }, function (e, t) {
      fe.each({ padding: "inner" + e, content: t, "": "outer" + e }, function (
        n,
        i
      ) {
  ...
  return (
    (fe.noConflict = function (t) {
      return (
        e.$ === fe && (e.$ = Bt), t && e.jQuery === fe && (e.jQuery = $t), fe
      );
    }),
    t || (e.jQuery = e.$ = fe),
    fe
    ...
    e.extend(e.easing, {
      ...
      easeInOutElastic: function (e) {
        return 0 === e
          ...
          ? 1
          : e < 0.5
          ? (-n(2, 20 * e - 10) * r((20 * e - 11.125) * c)) / 2
          : (n(2, -20 * e + 10) * r((20 * e - 11.125) * c)) / 2 + 1;
      },
    ...
    (function (t) {
      ...
      function r(n, r) {
        ...
        if (
          ...
          (o = n.originalEvent),
          (a = E),
          f.search(/^(mouse|click)/) > -1 && (a = I),
          o)
        )
          for (d = a.length; d; ) (l = a[--d]), (n[l] = o[l]);
        if (
          (f.search(/mouse(down|up)|click/) > -1 && !n.which && (n.which = 1),
          -1 !== f.search(/^touch/) &&
            ((s = t(o)),
            (f = s.touches),
            (u = s.changedTouches),
      ...
      function p(t) {
        ...
        "click" === t.type &&
          ...
          setTimeout(function () {
            "touchstart" === e.data(t.target, "lastTouchType") &&
              (l(), delete e.data(t.target).lastTouchType, p(t));
      ...
      function f(n) {
        ...
        s &&
          ...
          ((i = n.target),
          (r = o(i)),
          e.data(n.target, "lastTouchType", n.type),
          r.hasVirtualBinding &&
            ((H = q++),
            e.data(i, S, H),
            c(),
      ...
      function g(n) {
        if (!F) {
          var i = t(n).touches[0],
            ...
            s = o(n.target);
          e.data(n.target, "lastTouchType", n.type),
            (_ = _ || Math.abs(i.pageX - N) > a || Math.abs(i.pageY - G) > a) &&
              !r &&
              h("vmousecancel", n, s),
            h("vmousemove", n, s),
            d();
          ...
          h("vmouseup", n, l),
            _ ||
              ((r = h("vclick", n, l)) &&
                ...
                ((a = t(n).changedTouches[0]),
                M.push({ touchID: H, x: a.clientX, y: a.clientY }),
                (O = !0))),
            h("vmouseout", n, l),
            (_ = !1),
            d();
          ...
          function (t) {
            ...
            if (s)
              for (
                n = t.clientX,
                  i = t.clientY,
                  k = e.vmouse.clickDistanceThreshold,
                  r = l;
                r;
      ...
      (function (t) {
        ...
        return (e.mobile = { version: "@VERSION" }), e.mobile;
      }),
      (function (t) {
        "function" == typeof define && define.amd
          ? define("support/touch", ["jquery", "../ns"], t)
          : t(e);
      })(function (e) {
        var t = { touch: "ontouchend" in n };
        return (
          (e.mobile.support = e.mobile.support || {}),
          e.extend(e.support, t),
          e.extend(e.mobile.support, t),
          e.support
        );
      }),
      (function (t) {
        ...
        function r(t, n, r, o) {
          var a = r.type;
          (r.type = n),
            o ? e.event.trigger(r, i, t) : e.event.dispatch.call(t, r),
            (r.type = a);
        }
        var o = e(n),
                ...
                (c = function (e) {
                  ...
                  (u = setTimeout(function () {
                    e.event.special.tap.emitTapOnTaphold || (i = !0),
                      (u = 0),
                      r(t, "taphold", e.Event("taphold", { target: d }));
          ...
          (e.event.special.swipe = {
            ...
            getLocation: function (e) {
              ...
              return (
                ...
                (0 === e.pageX && Math.floor(r) > Math.floor(e.pageX))
                  ? ((r -= n), (o -= i))
                  : (o < e.pageY - i || r < e.pageX - n) &&
                    ((r = e.pageX - n), (o = e.pageY - i)),
                { x: r, y: o }
              );
            },
            start: function (t) {
              ...
              if (
                ...
                return (
                  ...
                  r(
                    i,
                    a,
                    e.Event(a, { target: o, swipestart: t, swipestop: n }),
                    !0
                  ),
                  !0
                );
                  ...
                  if (!e.event.special.swipe.eventInProgress) {
                    ...
                    (r.move = function (t) {
                      a &&
                        ...
                        c ||
                          ((c = e.event.special.swipe.handleSwipe(
                            a,
                            i,
                            n,
                            s
                        ...
                        Math.abs(a.coords[0] - i.coords[0]) >
            ...
            teardown: function () {
              ...
              (t = e.data(this, "mobile-events")) &&
                ...
                n &&
                  (n.start && e(this).off(s, n.start),
                  n.move && o.off(u, n.move),
                  n.stop && o.off(l, n.stop));
            },
          }),
          e.each(
            {
        ...
        e.bind(t, function (t) {
          function r(e) {
            if (s) {
              ...
              (o = { time: new Date().getTime(), coords: [t.pageX, t.pageY] }),
                Math.abs(s.coords[1] - o.coords[1]) > 10 && e.preventDefault();
            }
          }
          var o,
            a = t.originalEvent.touches ? t.originalEvent.touches[0] : t,
            s = {
              time: new Date().getTime(),
          ...
          e.bind(i, r).one(n, function (t) {
            e.unbind(i, r),
              s &&
                o &&
                o.time - s.time < 1e3 &&
                Math.abs(s.coords[1] - o.coords[1]) > 30 &&
                Math.abs(s.coords[0] - o.coords[0]) < 75 &&
                s.origin
                  .trigger("swipeupdown")
                  .trigger(s.coords[1] > o.coords[1] ? "swipeup" : "swipedown"),
              (s = o = void 0);
          });
        });
      },
    }),
      $.each({ swipedown: "swipeupdown", swipeup: "swipeupdown" }, function (
        e,
        t
      ) {
        $.event.special[e] = {
  ...
  ("MacIntel" === navigator.platform &&
    ...
    !window.MSStream)
    ? ((isMobile = !0), $("html").addClass("isMobile"))
    : ((isMobile = !1), $("html").removeClass("isMobile")),
  (function (e, t) {
    ...
    function e(t, n, i) {
      if (!t.s) {
        ...
        if (i && i.then)
          return void i.then(e.bind(null, t, n), e.bind(null, t, 2));
        (t.s = n), (t.v = i);
        var r = t.o;
        r && r(t);
      }
    ...
    function n(e, t) {
      for (
        ...
        var d = n[0],
          h = n[1],
          p = n.index;
        if (((s += e.slice(a, p)), (a = p + d.length), h))
          (s += h[1]), (c = !0);
        else {
          var f = "",
            m = n[2],
    ...
    function i(e) {
      ...
      return function (n, i) {
        for (
          var r = "", o = (i && i.encode) || encodeURIComponent, a = 0;
          a < e.length;
          a++
        ) {
          var s = e[a];
        ...
        (t.prototype.return = function (t) {
          ...
          return (i.l = new Promise(function (r) {
            ...
            if (null === o)
              return null === i.t
                ? r(i.l)
                : ((i.t = null), r(t && t.then ? t.then(n) : n(t)));
    ...
    var c,
      ...
      h =
        ((function (e) {
          var t = ((c = { exports: {} }).exports = function (e, t) {
            return (
              (t = t || function () {}),
              function () {
                var n = !1,
    ...
    var C = new S(),
      ...
      E = { current: { configurable: !0 }, previous: { configurable: !0 } };
    ...
    var A = new P(),
              ...
              return Promise.resolve(e).then(function (e) {
                ...
                if (e) {
                  ...
                  (n.namespace = C.getNamespace(r)),
                    ...
                    (n.html = e),
                    "popstate" === i
                      ? A.add(n.url.href, n.namespace)
                      : A.push(n.url.href, n.namespace);
      ...
      L = v,
      N = { update: I, nextTick: D, pathToRegexp: L },
      G = function () {
      ...
      M = function (e) {
        ...
        var o = n.indexOf("?");
        return (
          o >= 0 && ((i = O(n.slice(o + 1))), (n = n.slice(0, o))),
    ...
    var q = (function (e) {
      ...
      V = function (e) {
        var t = e.el;
        return t.hasAttribute("target") && "_self" === t.target;
      },
      W = function (e) {
        var t = e.el;
        return (
      ...
      Y = function (e) {
        return Boolean(
          e.el.closest("[" + x.prefix + "-" + x.prevent + '="all"]')
        );
      },
      K = function (e) {
      ...
      (J.prototype.resolve = function (e, t) {
        ...
        var o = new Map(),
          a = r.find(function (n) {
            ...
            return (
              !(!t.self || "self" !== n.name) ||
              (i.k.reverse().forEach(function (o) {
                r &&
                  ((r = i.O(n, o, e, a)),
                  t.appear ||
                    (n.from &&
                      n.to &&
                      (r = i.O(n, o, e, a, "from") && i.O(n, o, e, a, "to")),
                    n.from && !n.to && (r = i.O(n, o, e, a, "from")),
                    !n.from && n.to && (r = i.O(n, o, e, a, "to"))));
              }),
              o.set(n, a),
              r)
            );
          ...
          l = [];
        if (
          (l.push(t.appear ? "appear" : "page"), t.self && l.push("self"), s)
        ) {
          var u = [a];
        ...
        if (r ? h && h[l] : h[l]) {
          switch (t.type) {
            ...
            case "object":
              ...
              p[c] &&
                (p[c].name && -1 !== m.indexOf(p[c].name) && (a = !0),
    ...
    (Z.prototype.get = function (e, t) {
      ...
      (Z.prototype.doAppear = function (e) {
        ...
        try {
          ...
          var s = t(
            function () {
              return Promise.resolve(r.$("beforeAppear", n, a)).then(
                function () {
      ...
      (Z.prototype.doPage = function (e) {
        ...
        try {
          ...
          var c = t(
            function () {
              function e() {
                return Promise.resolve(a.$("before", n, l)).then(function () {
                  function e(e) {
                    return Promise.resolve(a.$("after", n, l)).then(
                      function () {
                        return Promise.resolve(
                          a.remove(n)
                        ).then(function () {});
                          ...
                          return Promise.resolve(a.add(n, o)).then(function () {
                            return Promise.resolve(
                              ...
                              return Promise.resolve(
                                ...
                                return Promise.resolve(
                                  Promise.all([a.leave(n, l), a.enter(n, l)])
                                ).then(function () {
                                  return Promise.resolve(
                                    a.$("afterLeave", n, l)
                                  ).then(function () {
                        ...
                        s = t(
                          function () {
                            return Promise.resolve(
                              ...
                              return Promise.resolve(
                                Promise.all([a.leave(n, l), I(r, n)]).then(
                                  function (e) {
                                    return e[0];
                                  }
                                )
            ...
            function (e) {
              throw (
                ((a.S = !1), a.logger.error(e), new Error("Transition error"))
              );
            }
          );
    ...
    var ne = {
      ...
      re = { data: { configurable: !0 }, wrapper: { configurable: !0 } };
    return (
      ...
      (ie.prototype.init = function (e) {
        ...
        this.history.add(d.url.href, d.namespace),
      ...
      (ie.prototype.page = function (e, n, i) {
        try {
          ...
          var a = r.cache.has(e)
              ...
              : r.cache.set(
                  e,
                  r.request(e, r.timeout, r.onRequestError.bind(r, n)),
                  "click"
                ).request,
            s = (function () {
              if (r.transitions.shouldWait)
                return Promise.resolve(I(a, r.data)).then(function () {});
            })();
          return s && s.then ? s.then(o) : o();
        } catch (e) {
          return Promise.reject(e);
  ...
  (function (e, t, n, i) {
    var r = (function () {
      ...
      o = t.console || { log: function () {}, time: function () {} },
      a = "blast",
      s = {
        latinPunctuation: "–—′’'“″„\"(«.…¡¿′’'”″“\")».…!?",
        latinLetters:
    ...
    (e.fn[a] = function (u) {
      ...
      function d(e, t) {
        ...
        if (
          ((i.className = a),
          t.customClass &&
            ((i.className += " " + t.customClass),
            t.generateIndexID && (i.id = t.customClass + "-" + g.blastedIndex)),
          "all" === t.delimiter &&
            /\s/.test(e.data) &&
          ...
          var r,
            o = e.data;
          "word" === t.delimiter &&
            l.onlyContainsPunctuation.test(o) &&
            (o = o.replace(l.adjoinedPunctuation, "")),
            (r = a + "-" + t.delimiter.toLowerCase() + "-" + o.toLowerCase()),
            (i.className += " " + r);
        }
        return (
          t.aria && i.setAttribute("aria-hidden", "true"),
          i.appendChild(e.cloneNode(!1)),
          i
        );
      }
      function h(e, t) {
        ...
        if (3 === e.nodeType && e.data.length) {
          if (
            ...
            var s = e.splitText(n);
            s.splitText(o.length),
              (i = 1),
              t.search || "sentence" !== t.delimiter || (s.data = c(s.data));
          ...
          for (var p = 0; p < e.childNodes.length; p++)
            (g.nodeBeginning = !0), (p += h(e.childNodes[p], t));
        return i;
      }
      function p(n, s) {
        ...
        n
          ...
          t.Zepto ? n.data(a, i) : n.removeData(a),
          s.debug &&
            (o.log(
              a +
                ": Reversed Blast" +
                (n.attr("id") ? " on #" + n.attr("id") + "." : ".") +
                (l
                  ? " Skipped reversal on the children of one or more descendant root elements."
                  : "")
            ),
            o.timeEnd("blast reversal"));
      }
      var f,
        m = e.extend({}, e.fn[a].defaults, u),
        g = {};
      if (
        m.search.length &&
        ...
        (this.each(function () {
          ...
          if (!1 !== u) {
            (g = {
              ...
              t.data(a) === i ||
                ("search" === t.data(a) && !1 !== m.search) ||
                (p(t, m),
                m.debug &&
                  o.log(a + ": Removed element's existing Blast call.")),
              t.data(a, !1 !== m.search ? "search" : m.delimiter),
              m.aria && t.attr("aria-label", r),
              m.stripHTMLTags && t.html(r);
            try {
              n.createElement(m.tag);
            } catch (e) {
              (m.tag = "span"),
                m.debug &&
                  o.log(a + ": Invalid tag supplied. Defaulting to span.");
            }
            t.addClass(a + "-root"),
              m.debug && o.time(a),
              h(this, m),
          ...
          m.debug &&
            e.each(g.wrappers, function (e, t) {
              o.log(a + " [" + m.delimiter + "] " + this.outerHTML),
          ...
          (o = [].concat(t(o), [h])),
            ...
            (e.ontouchmove = function (t) {
              ...
              1 === t.targetTouches.length &&
                ((i = e),
                (o = (n = t).targetTouches[0].clientY - s),
                !c(n.target) &&
                  (i && 0 === i.scrollTop && 0 < o
                    ? d(n)
                    : (r = i) &&
  ...
  "object" == typeof navigator &&
    (function (e, t) {
      ...
      function y(e) {
        ge.nodeList(e) || ge.array(e)
          ? Array.from(e).forEach(y)
          : ge.element(e) &&
            ge.element(e.parentNode) &&
      ...
      function k(e, t) {
        return ge.element(t) && ge.element(t.parentNode) && ge.element(e)
      ...
      function H(e, t) {
        if (ge.string(e)) {
          ...
          if (!n || !i()) {
            ...
            if (
              (a.setAttribute("hidden", ""), n && a.setAttribute("id", t), o)
            ) {
      ...
      function U() {
        if (this.enabled) {
          ...
          ge.element(e) && (e.pressed = this.active),
            h.call(
              this.player,
              this.target,
      ...
      function X() {
        ...
        if (
          ...
          S(this.target, this.player.config.classNames.fullscreen.fallback, e),
          be.isIos)
        ) {
      ...
      var J = { addCSS: !0, thumbWidth: 15, watch: !0 },
        Z = function (e) {
        ...
        ae = {
          ...
          empty: function (e) {
            return (
              te(e) ||
              ((ie(e) || re(e) || oe(e)) && !e.length) ||
              (ne(e) && !Object.keys(e).length)
            );
          },
        },
        se = (function () {
          function t(n, i) {
            e(this, t),
              ae.element(n)
                ? (this.element = n)
                : ae.string(n) && (this.element = document.querySelector(n)),
              ae.element(this.element) &&
                ae.empty(this.element.rangeTouch) &&
                ((this.config = Object.assign({}, J, i)), this.init());
          }
          return (
            n(
              t,
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    var n,
                      ...
                      d =
                        ((100 / c.width) * (this.config.thumbWidth / 2)) / 100;
                    return (
              ...
              [
                {
                  ...
                  value: function (e) {
                    var n =
                      ...
                      i = null;
                    if (
                      (ae.empty(e) || ae.string(e)
                        ? (i = Array.from(
                            document.querySelectorAll(
                              ae.string(e) ? e : 'input[type="range"]'
                            )
                          ))
                        : ae.element(e)
                        ? (i = [e])
                        : ae.nodeList(e)
                        ? (i = Array.from(e))
                        : ae.array(e) && (i = e.filter(ae.element)),
                      ae.empty(i))
                    )
                      return null;
        ...
        me = function (e) {
          return (
            ce(e) ||
            ((he(e) || pe(e) || fe(e)) && !e.length) ||
            (de(e) && !Object.keys(e).length)
          );
        },
        ge = {
          nullOrUndefined: ce,
        ...
        ke = {
          ...
          pip:
            !be.isIPhone &&
            (!!ge.function(v("video").webkitSetPresentationMode) ||
              !(
                !document.pictureInPictureEnabled ||
                v("video").disablePictureInPicture
              )),
        ...
        Te = {
          ...
          extend: function () {
            if (this.isHTML5) {
              var e = this;
              ge.empty(this.config.ratio) || G.call(e),
        ...
        Ie = {
          getIconUrl: function () {
            var e =
              ...
              (be.isIE && !window.svg4everybody);
            return { url: this.config.iconUrl, cors: e };
          },
          findElements: function () {
            try {
              return (
                (this.elements.controls = A.call(
                  this,
                ...
                ge.element(this.elements.progress) &&
          ...
          createIcon: function (e, t) {
            ...
            g(r, f(t, { role: "presentation", focusable: "false" }));
          ...
          createBadge: function (e) {
            ...
            var t = v("span", { class: this.config.classNames.menu.value });
            return (
              t.appendChild(
                v("span", { class: this.config.classNames.menu.badge }, e)
              ),
              t
            );
          },
          createButton: function (e, t) {
            ...
            switch (
              ...
              case "play-large":
                ...
                break;
              default:
                ge.empty(o.label) && (o.label = r),
                  ge.empty(o.icon) && (o.icon = e);
            }
            var a = v(o.element);
            return (
              o.toggle
                ? (a.appendChild(
                    Ie.createIcon.call(this, o.iconPressed, {
                      class: "icon--pressed",
                    })
                  ),
                  a.appendChild(
                    Ie.createIcon.call(this, o.icon, {
                      class: "icon--not-pressed",
                    })
                  ),
                  a.appendChild(
                    Ie.createLabel.call(this, o.labelPressed, {
                      class: "label--pressed",
                    })
                  ),
                  a.appendChild(
                    Ie.createLabel.call(this, o.label, {
                      class: "label--not-pressed",
                    })
                  ))
                : (a.appendChild(Ie.createIcon.call(this, o.icon)),
                  a.appendChild(Ie.createLabel.call(this, o.label))),
              f(i, T(this.config.selectors.buttons[r], i)),
              g(a, i),
              "play" === r
                ? (ge.array(this.elements.buttons[r]) ||
                    (this.elements.buttons[r] = []),
                  this.elements.buttons[r].push(a))
                : (this.elements.buttons[r] = a),
              a
            );
          },
          createRange: function (e, t) {
            var n = v(
              "input",
              f(
                T(this.config.selectors.inputs[e]),
                {
                  type: "range",
                  min: 0,
                  max: 100,
            ...
            return (
              ...
              Ie.updateRangeFill.call(this, n),
              se.setup(n),
              n
            );
          },
          createProgress: function (e, t) {
            var n = v(
              "progress",
              f(
                T(this.config.selectors.display[e]),
                {
                  min: 0,
                  max: 100,
                  value: 0,
              ...
              function (i) {
                if (
                  ...
                  if (!r && [32, 39].includes(i.which))
                    Ie.showMenuPanel.call(n, t, !0);
                  else {
                    var o;
                    32 !== i.which &&
                      (40 === i.which || (r && 39 === i.which)
                        ? ((o = e.nextElementSibling),
                          ge.element(o) || (o = e.parentNode.firstElementChild))
                        : ((o = e.previousElementSibling),
                          ge.element(o) || (o = e.parentNode.lastElementChild)),
                      I.call(n, o, !0));
                  }
                }
              },
          ...
          createMenuItem: function (e) {
            ...
            (h.innerHTML = o),
              ...
              Ie.bindMenuItemShortcuts.call(this, d, r),
              i.appendChild(d);
          },
          formatTime: function () {
            var e =
          ...
          updateTimeDisplay: function () {
            ...
            ge.element(e) &&
              ge.number(t) &&
              (e.innerText = Ie.formatTime(t, n));
          },
          updateVolume: function () {
            this.supported.ui &&
              (ge.element(this.elements.inputs.volume) &&
                Ie.setRange.call(
                  this,
                  this.elements.inputs.volume,
                  this.muted ? 0 : this.volume
                ),
              ge.element(this.elements.buttons.mute) &&
                ...
                switch (e.type) {
                  ...
                  case "seeked":
                    (n = (function (e, t) {
                      ...
                      "timeupdate" === e.type &&
                        Ie.setRange.call(this, this.elements.inputs.seek, n);
                    break;
                  case "playing":
                  case "progress":
                    !(function (e, n) {
          ...
          updateSeekTooltip: function (e) {
            ...
            if (
              ...
              ge.element(this.elements.inputs.seek) &&
              ge.element(this.elements.display.seekTooltip) &&
              0 !== this.duration
            ) {
          ...
          timeUpdate: function (e) {
            var t =
              !ge.element(this.elements.display.duration) &&
          ...
          durationUpdate: function () {
            if (
              ...
              if (this.duration >= Math.pow(2, 32))
                return (
                  x(this.elements.display.currentTime, !0),
                  void x(this.elements.progress, !0)
                );
              ge.element(this.elements.inputs.seek) &&
              ...
              !e &&
                ...
                Ie.updateSeekTooltip.call(this);
            }
          },
          ...
          updateSetting: function (e, t, n) {
            ...
            if ("captions" === e) r = this.currentTrack;
              ...
              if (
                ((r = ge.empty(n) ? this[e] : n),
                ge.empty(r) && (r = this.config[e].default),
                !ge.empty(this.options[e]) && !this.options[e].includes(r))
              )
            ...
            if (
              (ge.element(o) || (o = i && i.querySelector('[role="menu"]')),
              ge.element(o))
            ) {
              this.elements.settings.buttons[e].querySelector(
                ".".concat(this.config.classNames.menu.value)
              ).innerHTML = Ie.getLabel.call(this, e, r);
          ...
          setQualityMenu: function (e) {
            ...
            if (ge.element(this.elements.settings.panels.quality)) {
              ...
              ge.array(e) &&
                (this.options.quality = _(e).filter(function (e) {
                  return t.config.quality.options.includes(e);
                }));
              var i =
                !ge.empty(this.options.quality) &&
                this.options.quality.length > 1;
              if (
                (Ie.toggleMenuButton.call(this, "quality", i),
                w(n),
                Ie.checkMenu.call(this),
                i)
              ) {
          ...
          setCaptionsMenu: function () {
            ...
            if (ge.element(this.elements.settings.panels.captions)) {
              var t = this.elements.settings.panels.captions.querySelector(
                ...
                i = Boolean(n.length);
              if (
                (Ie.toggleMenuButton.call(this, "captions", i),
                w(t),
                Ie.checkMenu.call(this),
                i)
              ) {
                var r = n.map(function (n, i) {
                  return {
                    ...
                    badge:
                      n.language &&
                      Ie.createBadge.call(e, n.language.toUpperCase()),
                    list: t,
                    type: "language",
                  };
                });
                r.unshift({
                  ...
                  r.forEach(Ie.createMenuItem.bind(this)),
                  Ie.updateSetting.call(this, "captions", t);
              }
            }
          },
          setSpeedMenu: function (e) {
            ...
            if (ge.element(this.elements.settings.panels.speed)) {
              ...
              var i =
                !ge.empty(this.options.speed) && this.options.speed.length > 1;
              Ie.toggleMenuButton.call(this, "speed", i),
                w(n),
                Ie.checkMenu.call(this),
                i &&
          ...
          toggleMenu: function (e) {
            ...
            if (ge.element(t) && ge.element(n)) {
              ...
              if (ge.boolean(e)) r = e;
                ...
                var o = ge.function(e.composedPath)
                    ? e.composedPath()[0]
                    : e.target,
                  a = t.contains(o);
              ...
              n.setAttribute("aria-expanded", r),
                x(t, !r),
                S(this.elements.container, this.config.classNames.menu.open, r),
                r && ge.keyboardEvent(e)
                  ? Ie.focusFirstMenuItem.call(this, null, !0)
                  : r || i || I.call(this, n, ge.keyboardEvent(e));
            }
          },
          ...
          showMenuPanel: function () {
            ...
            if (ge.element(i)) {
              ...
              if (ke.transitions && !ke.reducedMotion) {
                (r.style.width = "".concat(o.scrollWidth, "px")),
                  (r.style.height = "".concat(o.scrollHeight, "px"));
          ...
          create: function (e) {
            ...
            return (
              _(this.config.controls).forEach(function (s) {
                if (
                  ("restart" === s && d.appendChild(i.call(t, "restart", h)),
                  "rewind" === s && d.appendChild(i.call(t, "rewind", h)),
                  "play" === s && d.appendChild(i.call(t, "play", h)),
                  "fast-forward" === s &&
                    d.appendChild(i.call(t, "fast-forward", h)),
                  "progress" === s)
                ) {
                  var l = v("div", {
                  ...
                  if (
                    (p.appendChild(
                      o.call(t, "seek", { id: "plyr-seek-".concat(e.id) })
                    ),
                    p.appendChild(r.call(t, "buffer")),
                ...
                if (
                  ("current-time" === s &&
                    d.appendChild(a.call(t, "currentTime", h)),
                  "duration" === s && d.appendChild(a.call(t, "duration", h)),
                  "mute" === s || "volume" === s)
                ) {
                  var g = t.elements.volume;
                  if (
                    ((ge.element(g) && d.contains(g)) ||
                      ((g = v(
                        "div",
                        f({}, h, {
                      ...
                      (t.elements.volume = g),
                      d.appendChild(g)),
                    "mute" === s && g.appendChild(i.call(t, "mute")),
                    "volume" === s)
                  ) {
                    var b = { max: 1, step: 0.05, value: t.config.volume };
                    g.appendChild(
                      o.call(
                        t,
                        "volume",
                        f(b, { id: "plyr-volume-".concat(e.id) })
                      )
                    );
                  }
                }
                if (
                  ("captions" === s && d.appendChild(i.call(t, "captions", h)),
                  "settings" === s && !ge.empty(t.config.settings))
                ) {
                  var y = v(
                    "div",
                    f({}, h, {
                  ...
                  x.appendChild(S),
                    k.appendChild(x),
                    (t.elements.settings.panels.home = x),
                    t.config.settings.forEach(function (i) {
                      var r = v(
                        "button",
                        f(T(t.config.selectors.buttons.settings), {
                          type: "button",
                          class: ""
                      ...
                      l.appendChild(
                        v("span", { "aria-hidden": !0 }, Se.get(i, t.config))
                      ),
                        l.appendChild(
                          v(
                            "span",
                            { class: t.config.classNames.hidden },
                            Se.get("menuBack", t.config)
                          )
                        ),
                        u(
                          s,
                    ...
                    y.appendChild(w),
                    d.appendChild(y),
                    (t.elements.settings.popup = w),
                    (t.elements.settings.menu = y);
                }
                if (
                  ("pip" === s && ke.pip && d.appendChild(i.call(t, "pip", h)),
                  "airplay" === s &&
                    ke.airplay &&
                    d.appendChild(i.call(t, "airplay", h)),
                  "download" === s)
                ) {
                  var C = f({}, h, {
                      element: "a",
              ...
              this.isHTML5 && s.call(this, Te.getQualityOptions.call(this)),
              l.call(this),
              d
            );
          },
          inject: function () {
            ...
            var i = {
              ...
              o = !0;
            ge.function(this.config.controls) &&
              (this.config.controls = this.config.controls.call(this, i)),
              this.config.controls || (this.config.controls = []),
              ge.element(this.config.controls) ||
              ge.string(this.config.controls)
                ? (n = this.config.controls)
                : ((n = Ie.create.call(this, {
                    id: this.id,
                    seektime: this.config.seekTime,
                    speed: this.speed,
            ...
            o &&
              (ge.string(this.config.controls)
                ? (n = a(n))
                : ge.element(n) && (n.innerHTML = a(n.innerHTML)));
            var l;
            ge.string(this.config.selectors.controls.container) &&
              (l = document.querySelector(
                this.config.selectors.controls.container
              )),
              ge.element(l) || (l = this.elements.container);
            if (
              (l[
                ge.element(n) ? "insertAdjacentElement" : "insertAdjacentHTML"
              ]("afterbegin", n),
              ge.element(this.elements.controls) || Ie.findElements.call(this),
              !ge.empty(this.elements.buttons))
            ) {
              var u = function (t) {
              ...
              Object.values(this.elements.buttons)
                .filter(Boolean)
                .forEach(function (e) {
                  ge.array(e) || ge.nodeList(e)
                    ? Array.from(e).filter(Boolean).forEach(u)
                    : u(e);
                });
            }
            if ((be.isEdge && s(l), this.config.tooltips.controls)) {
              var c = this.config,
                ...
                h = c.selectors,
                p = ""
                  .concat(h.controls.wrapper, " ")
                  .concat(h.labels, " .")
                  .concat(d.hidden),
                f = E.call(this, p);
              Array.from(f).forEach(function (t) {
                S(t, e.config.classNames.hidden, !1),
                  S(t, e.config.classNames.tooltip, !0);
              });
            }
          },
        },
          ...
          setup: function () {
            if (this.supported.ui)
              if (
                !this.isVideo ||
                this.isYouTube ||
                (this.isHTML5 && !ke.textTracks)
              )
                ge.array(this.config.controls) &&
                  this.config.controls.includes("settings") &&
                  this.config.settings.includes("captions") &&
                  Ie.setCaptionsMenu.call(this);
              else {
                if (
                  (ge.element(this.elements.captions) ||
                    ((this.elements.captions = v(
                      "div",
                      T(this.config.selectors.captions)
                    )),
                    (function (e, t) {
                      ge.element(e) &&
                        ge.element(t) &&
                ...
                if (
                  (ge.boolean(i) || (i = this.config.captions.active),
              ...
              t
                ...
                .forEach(function (t) {
                  e.debug.log("Track added", t),
                    o.set(t, { default: "showing" === t.mode }),
                    (t.mode = "hidden"),
                    u.call(e, t, "cuechange", function () {
                      return De.updateCues.call(e);
                    });
                }),
              ((s && this.language !== r) || !t.includes(a)) &&
                (De.setLanguage.call(this, r), De.toggle.call(this, i && s)),
              S(
                this.elements.container,
              ...
              if (r !== n) {
                if (
                  ...
                  return (
                    ...
                    void De.set.call(this, a.indexOf(s))
                  );
                }
                this.elements.buttons.captions &&
                  (this.elements.buttons.captions.pressed = r),
                  S(this.elements.container, i, r),
                  (this.captions.toggled = r),
                  Ie.updateSetting.call(this, "captions"),
                  h.call(
                    this,
                    this.media,
            ...
            if (-1 !== e)
              if (ge.number(e))
                if (e in n) {
                  ...
                  De.toggle.call(this, !0, t),
                    this.isHTML5 && this.isVideo && De.updateCues.call(this);
          ...
          getLabel: function (e) {
            ...
            return (
              !ge.track(t) &&
                ...
                (t = De.getCurrentTrack.call(this)),
              ge.track(t)
                ? ge.empty(t.label)
                  ? ge.empty(t.language)
                    ? Se.get("enabled", this.config)
                    : e.language.toUpperCase()
                  : t.label
                : Se.get("disabled", this.config)
            );
          },
        ...
        Ne = { active: "picture-in-picture", inactive: "inline" },
        Ge = { html5: "html5", youtube: "youtube", vimeo: "vimeo" },
        _e = { audio: "audio", video: "video" },
        Me = function () {},
        Oe = (function () {
          function t() {
            var n =
          ...
          function t(n) {
            ...
            e(this, t),
              ...
              u.call(
                ...
                "dblclick",
                function (e) {
                  (ge.element(i.player.elements.controls) &&
            ...
            n(
              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    this.enabled &&
                      (be.isIos && this.player.config.fullscreen.iosNative
                        ? this.target.webkitEnterFullscreen()
                        : !t.native || this.forceFallback
                        ? X.call(this, !0)
                        : this.prefix
                        ? ge.empty(this.prefix) ||
                          this.target[
                            ""
                ...
                },
                {
                  ...
                  value: function () {
                    if (this.enabled)
                      if (be.isIos && this.player.config.fullscreen.iosNative)
                ...
                },
                {
                  key: "target",
                  get: function () {
                    return be.isIos && this.player.config.fullscreen.iosNative
                      ? this.player.media
                      : this.player.elements.container;
                  },
                },
        ...
        je = {
          ...
          build: function () {
            ...
            ge.element(this.elements.controls) ||
              (Ie.inject.call(this), this.listeners.controls()),
              je.toggleNativeControls.call(this),
              this.isHTML5 && De.setup.call(this),
              (this.volume = null),
              (this.muted = null),
              (this.loop = null),
              (this.quality = null),
              (this.speed = null),
              Ie.updateVolume.call(this),
              Ie.timeUpdate.call(this),
              je.checkPlaying.call(this),
              S(
                this.elements.container,
                this.config.classNames.pip.supported,
                ke.pip && this.isHTML5 && this.isVideo
              ),
              S(
                this.elements.container,
                this.config.classNames.airplay.supported,
                ke.airplay && this.isHTML5
              ),
              S(
                this.elements.container,
              ...
              this.config.duration && Ie.durationUpdate.call(this);
          },
          setTitle: function () {
            var e = Se.get("play", this.config);
            if (
              (ge.string(this.config.title) &&
                !ge.empty(this.config.title) &&
              ...
              ? (this.media.setAttribute("poster", e),
                function () {
                  ...
                  return new Promise(function (t) {
                    return e.ready
                      ? setTimeout(t, 0)
                      : u.call(e, e.elements.container, "ready", t);
                  }).then(function () {});
                }
                  .call(this)
                  .then(function () {
            ...
            n(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.config.keyboard.global &&
                    l.call(t, window, "keydown keyup", this.handleKey, e, !1),
                    l.call(t, document.body, "click", this.toggleMenu, e),
                    d.call(t, document.body, "touchstart", this.firstTouch),
                    l.call(
                      t,
                      document.body,
                      "keydown focus blur",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  !t.keyboard.global &&
                    t.keyboard.focused &&
                    u.call(e, n.container, "keydown keyup", this.handleKey, !1),
                    u.call(
                      e,
                      n.container,
                  ...
                  u.call(
                    ...
                    function (t) {
                      ...
                      if (
                        s === n.container &&
                        (e.isEmbed || !ge.empty(e.config.ratio))
                      ) {
                        ...
                        !(function (t, n, i) {
                          ...
                          l ||
                            (d
                              ? u.call(e, window, "resize", a)
                              : c.call(e, window, "resize", a));
                      }
                    }
                  );
                },
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    n = t.elements;
                  if (
                    (u.call(t, t.media, "timeupdate seeking seeked", function (
                      e
                    ) {
                  ...
                  u.call(t, t.media, r, function (e) {
                    ...
                    "error" === e.type && (r = t.media.error),
                      h.call(t, n.container, e.type, !0, r);
                  });
                },
              },
              {
                ...
                value: function (e, t, n) {
                  var i = this.player,
                    ...
                    o = !0;
                  ge.function(r) && (o = r.call(i, e)),
                    o && ge.function(t) && t.call(i, e);
                },
              },
              {
                key: "bind",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                      ...
                      function (e) {
                        ...
                        [13, 32].includes(n) &&
                          (13 !== n
                            ? (e.preventDefault(),
                              e.stopPropagation(),
                              Ie.toggleMenu.call(t, e))
                            : Ie.focusFirstMenuItem.call(t, null, !0));
                      },
                      null,
                      !1
                    ),
                    ...
                    this.bind(n.inputs.seek, "mousedown mousemove", function (
                      e
                    ) {
                  ...
                  this.bind(
                    ...
                    be.isWebkit &&
                      Array.from(E.call(t, 'input[type="range"]')).forEach(
                        function (n) {
                    ...
                    this.bind(n.controls, "mouseenter mouseleave", function (
                      e
                    ) {
                    ...
                    this.bind(n.controls, "focusin", function () {
                      var i = t.config,
                        r = t.timers;
                      S(n.controls, i.classNames.noTransition, !0),
              ...
              function n(e, t, i, o) {
                ...
                (o = o || 0),
                  /(^css!|\.css$)/.test(e)
                    ...
                    ? ((s = l.createElement("img")).src = h)
                    : (((s = l.createElement("script")).src = e),
                      (s.async = void 0 === u || u)),
                  (s.onload = s.onerror = s.onbeforeload = function (r) {
                    var l = r.type[0];
                    if (a)
                      try {
              ...
              function i(i, r, a) {
                function s(r, o) {
                  !(function (e, t, i) {
                    ...
                    i,
                    function (n) {
                      t(u, n), r && t({ success: r, error: o }, n), e(l, n);
                    },
                    u
                  );
                }
        ...
        He = {
          setup: function () {
            ...
            S(this.elements.wrapper, this.config.classNames.embed, !0),
              G.call(this),
              ge.object(window.Vimeo)
                ? He.ready.call(this)
                : Y(this.config.urls.vimeo.sdk)
                    .then(function () {
                      He.ready.call(e);
                    })
                    .catch(function (t) {
          ...
          ready: function () {
            ...
            Object.defineProperty(t.media, "currentTime", {
              ...
              set: function (e) {
                ...
                (i.seeking = !0),
                  h.call(t, i, "seeking"),
                  Promise.resolve(a && n.setVolume(0))
                    .then(function () {
            ...
            t.embed
              ...
              t.embed.getTextTracks().then(function (e) {
                (t.media.textTracks = e),
                  De.setup.call(t),
                  t.config.captions.active ||
                    setTimeout(function () {
                      t.embed.disableTextTrack(),
                        $(e).each(function (t) {
                          e[t].mode = "disabled";
                        });
                    }, 100);
        ...
        $e = {
          setup: function () {
            ...
            if (
              (S(this.elements.wrapper, this.config.classNames.embed, !0),
              ge.object(window.YT) && ge.function(window.YT.Player))
            )
              $e.ready.call(this);
            else {
          ...
          getTitle: function (e) {
            var t = this;
            q(M(this.config.urls.youtube.api, e))
              .then(function (e) {
                if (ge.object(e)) {
                  var n = e.title,
                    i = e.height,
          ...
          setup: function () {
            this.media
              ? (S(
                ...
                this.isVideo &&
                  ((this.elements.wrapper = v("div", {
                    class: this.config.classNames.video,
                  })),
                  m(this.media, this.elements.wrapper),
                  (this.elements.poster = v("div", {
                ...
                this.isHTML5
                  ...
                  : this.isYouTube
                  ? $e.setup.call(this)
                  : this.isVimeo && He.setup.call(this))
            ...
            n(t, [
              {
                ...
                value: function () {
                  var e = this;
                  this.enabled &&
                    (ge.object(window.google) && ge.object(window.google.ima)
                      ? this.ready()
                      : Y(this.player.config.urls.googleIMA.sdk)
                          .then(function () {
                            e.ready();
                          })
                          .catch(function () {
                ...
                value: function () {
                  ...
                  this.countdownTimer = setInterval(function () {
                    var t = B(Math.max(e.manager.getRemainingTime(), 0)),
                      n = ""
                        .concat(Se.get("advertisement", e.player.config), " - ")
                        .concat(t);
              ...
              },
              {
                ...
                value: function (e, t) {
                  return (
                    ge.array(this.events[e]) || (this.events[e] = []),
              ...
              },
              {
                ...
                value: function (e) {
                  ge.nullOrUndefined(this.safetyTimer) ||
                    (this.player.debug.log(
              ...
              },
              {
                ...
                get: function () {
                  ...
                  return (
                    ...
                    this.player.isVideo &&
                    e.enabled &&
                    (!ge.empty(e.publisherId) || ge.url(e.tagUrl))
                  );
                },
              },
              {
            ...
            n(t, [
                  ...
                  if (
                    ...
                    if ("touchmove" === e.type)
                      ...
                      (this.seekTime = this.player.media.duration * (n / 100)),
                        ...
                        (this.elements.thumb.time.innerText = B(this.seekTime));
                    }
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.elements.thumb.time = v("span", {}, "00:00")),
                    e.appendChild(this.elements.thumb.time),
                    this.elements.thumb.container.appendChild(e),
                    ge.element(this.player.elements.progress) &&
                      this.player.elements.progress.appendChild(
                        this.elements.thumb.container
                      ),
                    (this.elements.scrubbing.container = v("div", {
                      class: this.player.config.classNames.previewThumbnails
                        .scrubbingContainer,
                    })),
                ...
                this.destroy.call(
                  ...
                  function () {
                    (t.options.quality = []),
                      y(t.media),
                      (t.media = null),
                      ge.element(t.elements.container) &&
                    ...
                    Object.assign(t, {
                      ...
                      t.isHTML5 &&
                        ...
                        ge.empty(e.poster) || (t.poster = e.poster),
                      ...
                      t.isHTML5 && Ue.insertElements.call(t, "source", n),
                      (t.config.title = e.title),
                      Be.setup.call(t),
                      t.isHTML5 &&
                        Object.keys(e).includes("tracks") &&
                        Ue.insertElements.call(t, "track", e.tracks),
        ...
        Xe = (function () {
          function t(n, i) {
            ...
            if (
              ...
              (this.touch = ke.touch),
              (this.media = n),
              ge.string(this.media) &&
                (this.media = document.querySelectorAll(this.media)),
              ((window.jQuery && this.media instanceof jQuery) ||
                ge.nodeList(this.media) ||
                ge.array(this.media)) &&
              ...
              this.debug.log("Support", ke),
              !ge.nullOrUndefined(this.media) && ge.element(this.media))
            )
              if (this.media.plyr) this.debug.warn("Target already setup");
                ...
                if (ke.check().api) {
                  ...
                  switch (a) {
                    case "div":
                      if (
                        ((s = this.media.querySelector("iframe")),
                        ge.element(s))
                      ) {
                        if (
                          ((l = V(s.getAttribute("src"))),
                  ...
                  (this.supported = ke.check(
                    ...
                    this.supported.api
                      ? ((this.eventListeners = []),
                        ...
                        (this.storage = new Ce(this)),
                        (this.media.plyr = this),
                        ge.element(this.elements.container) ||
                          ((this.elements.container = v("div", {
                            tabindex: 0,
                          })),
                          m(this.media, this.elements.container)),
                        ...
                        this.config.ads.enabled && (this.ads = new Ve(this)),
                        this.isHTML5 &&
                        ...
                        this.config.previewThumbnails.enabled &&
                          (this.previewThumbnails = new We(this)))
              ...
              [
                {
                  ...
                  value: function () {
                    var e = this;
                    return ge.function(this.media.play)
                      ? (this.ads &&
                          this.ads.enabled &&
                ...
                },
                {
                  ...
                  value: function () {
                    this.isHTML5
                      ...
                      : ge.function(this.media.stop) && this.media.stop();
                  },
                },
                {
                  key: "restart",
                ...
                },
                {
                  ...
                  value: function (e) {
                    this.currentTime =
                      this.currentTime -
                      (ge.number(e) ? e : this.config.seekTime);
                  },
                },
                {
                  key: "forward",
                  ...
                  value: function (e) {
                    if (this.supported.ui && !this.isAudio) {
                      ...
                      if (
                        (i &&
                          this.config.controls.includes("settings") &&
                          !ge.empty(this.config.settings) &&
                          Ie.toggleMenu.call(this, !1),
                        i !== t)
                      ) {
                        ...
                        (document.body.style.overflow = ""),
                          ...
                          n
                            ? (Object.keys(t.elements).length &&
                                (y(t.elements.buttons.play),
                                y(t.elements.captions),
                                y(t.elements.controls),
                                y(t.elements.wrapper),
                            ...
                            : (function () {
                              ...
                              ge.function(e) && e.call(t.elements.original),
                              (t.ready = !1),
                              setTimeout(function () {
                      ...
                      this.stop(),
                        ...
                        this.isHTML5
                          ...
                          ? (clearInterval(this.timers.buffering),
                            ...
                            null !== this.embed &&
                              ge.function(this.embed.destroy) &&
                              this.embed.destroy(),
                            i())
                          : this.isVimeo &&
                ...
                },
                {
                  ...
                  set: function (e) {
                    var t = e;
                    ge.string(t) && (t = Number(t)),
                      ge.number(t) || (t = this.storage.get("volume")),
                      ge.number(t) || (t = this.config.volume),
                      t > 1 && (t = 1),
                      t < 0 && (t = 0),
                      (this.config.volume = t),
                      (this.media.volume = t),
                      !ge.empty(e) && this.muted && t > 0 && (this.muted = !1);
                  },
                  get: function () {
                ...
                },
                {
                  ...
                  set: function (e) {
                    var t = e;
                    ge.boolean(t) || (t = this.storage.get("muted")),
                      ge.boolean(t) || (t = this.config.muted),
                      (this.config.muted = t),
                      (this.media.muted = t);
                  },
                  get: function () {
                ...
                },
                {
                  ...
                  set: function (e) {
                    var t = this,
                      n = null;
                    ge.number(e) && (n = e),
                      ge.number(n) || (n = this.storage.get("speed")),
                      ge.number(n) || (n = this.config.speed.selected);
                ...
                },
                {
                  ...
                  set: function (e) {
                    this.isVideo
                      ? ge.string(e) && D(e)
                        ? ((this.config.ratio = e), G.call(this))
                        : this.debug.error(
                ...
                },
                {
                  ...
                  set: function (e) {
                    if (ke.pip) {
                      ...
                      ge.function(this.media.webkitSetPresentationMode) &&
                        this.media.webkitSetPresentationMode(
                          t ? Ne.active : Ne.inactive
                        ),
                        ge.function(this.media.requestPictureInPicture) &&
                          (!this.pip && t
                  ...
                  get: function () {
                    return ke.pip
                      ? ge.empty(this.media.webkitPresentationMode)
                        ? this.media === document.pictureInPictureElement
                        : this.media.webkitPresentationMode === Ne.active
                      : null;
                  },
                },
              ],
                  ...
                  value: function (e) {
                    ...
                    return (
                      ge.string(e)
                        ...
                        : ge.nodeList(e)
                        ? (i = Array.from(e))
                        : ge.array(e) && (i = e.filter(ge.element)),
                      ge.empty(i)
                        ? null
                        : i.map(function (e) {
                            return new t(e, n);
...
var tabGlobal = new Array(),
  ...
  FF_SVGPoint = (function () {
    function e() {
      ...
      (t = Object.assign(n, t)),
        (this.x = t.x),
        (this.y = t.y),
        (this.drawCommand = t.drawCommand),
        (this.lineAnimBP = t.lineAnimBP),
        (this.onCoordinatesChangeObservable = new FF_SVGObservable()),
        (this.computedX = 0),
        (this.computedY = 0),
        window.addEventListener("resize", this.update.bind(this)),
        this.beforeInitialPositionCompute(t),
    ...
    return (
      ...
      _createClass(e, [
        { key: "beforeInitialPositionCompute", value: function (e) {} },
        {
          key: "update",
          value: function () {
            this.computePointPosition();
        ...
        },
        {
          ...
          value: function () {
            (this.computedX = this.x),
              ...
              this.onCoordinatesChangeObservable.notifyObservers();
          },
        },
        {
          key: "getX",
  ...
  FF_SVGPointRelativeToHTMLElement = (function (e) {
    function t() {
      ...
      return (
        ...
        )).attachPositionChangeObservers(),
        e
      );
    }
    return (
      _inherits(t, FF_SVGPoint),
      _createClass(t, [
        {
          key: "beforeInitialPositionCompute",
          value: function (e) {
            this.htmlElement = e.parentElement
              ? e.parentElement
          ...
          value: function () {
            ...
            (this.positionObserver = new MutationObserver(function (t, n) {
              ...
              this.htmlElement.addEventListener(
                "transitionend",
                this.computePointPosition.bind(this)
              );
          },
        },
        {
        ...
        },
        {
          ...
          value: function () {
            ...
            (this.computedX = e.left + this.x),
              (this.computedY = e.top + this.y),
              this.onCoordinatesChangeObservable.notifyObservers();
          },
        },
      ]),
  ...
  FF_SVGPointRelativeToHTMLElemPercent = (function (e) {
    function t() {
      ...
      return (
        _classCallCheck(this, t),
        _possibleConstructorReturn(this, _getPrototypeOf(t).call(this, e))
      );
    }
    return (
      _inherits(t, FF_SVGPointRelativeToHTMLElement),
      _createClass(t, [
        {
          key: "computePointPosition",
          value: function () {
            ...
            (this.computedX = t.left + (e.width * this.x) / 100),
              (this.computedY = t.top + (e.height * this.y) / 100),
              this.onCoordinatesChangeObservable.notifyObservers();
          },
        },
      ]),
  ...
  FF_SVGSectionsAnchorsMerge = (function (e) {
    ...
    return (
      _inherits(t, FF_SVGPointRelativeToHTMLElemPercent),
      _createClass(t, [
        {
          key: "beforeInitialPositionCompute",
          value: function (e) {
            ...
            (this.x = (t + n) / 2),
              (this.y = 0),
              (this.htmlElement = e.bottomSection.getHTMLElement()),
              (this.drawCommand = FF_SVGPoint.DRAW_COMMANDS.LINE_TO);
          },
        },
      ]),
      t
      ...
      _createClass(t, [
        {
          key: "beforeInitialPositionCompute",
          value: function (e) {
            (this.parentPoint = e.parentPoint
              ? e.parentPoint
              : new FF_SVGPoint(0, 0)),
              this.parentPoint.onCoordinatesChangeObservable.addObserver(this);
          },
        },
        {
          key: "computePointPosition",
          value: function () {
            (this.computedX = this.parentPoint.getComputedX() + this.x),
              (this.computedY = this.parentPoint.getComputedY() + this.y),
              this.onCoordinatesChangeObservable.notifyObservers();
          },
        },
      ]),
      ...
      _createClass(t, [
        {
          key: "beforeInitialPositionCompute",
          value: function (e) {
            (this.parentPointX = e.parentPointX),
              (this.parentPointY = e.parentPointY),
              this.parentPointX.onCoordinatesChangeObservable.addObserver(this),
              this.parentPointY.onCoordinatesChangeObservable.addObserver(this);
          },
        },
        {
          key: "computePointPosition",
          value: function () {
            (this.computedX = this.parentPointX.getComputedX()),
              (this.computedY = this.parentPointY.getComputedY()),
              this.onCoordinatesChangeObservable.notifyObservers();
          },
        },
        {
  ...
  FF_SVGAbstractPointsCollection = (function () {
    function e() {
      _classCallCheck(this, e),
        (this.childs = []),
        (this.onPointsChangeObservable = new FF_SVGObservable());
    }
    return (
      _createClass(e, [
        { key: "computePointsPosition", value: function () {} },
        {
          key: "getPoints",
          value: function () {
            return this.childs;
  ...
  FF_SVGLineModel = (function (e) {
    function t() {
      ...
      return (
        _classCallCheck(this, t),
        (e = _possibleConstructorReturn(this, _getPrototypeOf(t).call(this))),
        (e.recomputeInterval = n),
        (e.secondaryLinesPoints = []),
        e.attachRecomputeInterval(),
        e
      );
    }
    return (
      _inherits(t, FF_SVGAbstractPointsCollection),
      _createClass(
        t,
        [
          {
            ...
            value: function () {
              ...
              setInterval(function () {
                e.needsToRecompute &&
                  ((e.needsToRecompute = !1), e.computeLineData());
            ...
            value: function (e) {
              var t =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : -1;
              t > -1 && t < this.childs.length
                ? this.childs.splice(t, 0, e)
                : this.childs.push(e),
                this.watchNewLineComponent(e),
          ...
          },
          {
            ...
            value: function () {
              var e = [];
              return (
                this.iterateThroughPointsTree(function (t) {
                  return e.push(t);
                }),
                e
              );
          ...
          },
          {
            ...
            value: function () {
              var e = {};
              return (
                this.getFlatListPoints().forEach(function (t) {
  ...
  FF_SVGLineSection = (function (e) {
    function t(e, n, i) {
      ...
      return (
        _classCallCheck(this, t),
        (r = _possibleConstructorReturn(this, _getPrototypeOf(t).call(this))),
        (r.htmlElement = e),
        (r.topAnchorX = n),
        (r.bottomAnchorX = i),
        r
  ...
  FF_SVGLineAutoGeneratedSection = (function (e) {
    function t(e, n) {
      ...
      return (
        _classCallCheck(this, t),
        (i = _possibleConstructorReturn(this, _getPrototypeOf(t).call(this))),
        (i.startPoint = e),
        (i.endPoint = n),
        (i.firstLineLength = r),
        (i.direction = o),
      ...
      _createClass(t, [
        {
          ...
          value: function () {
            (this.point1 = new FF_SVGPointRelativeToOtherPoint({
              ...
              (this.childs[0] = this.point1),
              (this.childs[1] = this.point2);
          },
        },
        {
          ...
          value: function () {
            var e =
                this.endPoint.getComputedX() - this.startPoint.getComputedX(),
              n = this.endPoint.getComputedY() - this.startPoint.getComputedY();
            this.direction === t.DIRECTION.VERTICAL
              ? (this.point1.setX(0),
                this.point2.setX(0),
                this.point1.setY(n * this.firstLineLength),
                this.point2.setY(-1 * n * (1 - this.firstLineLength)))
              : this.direction === t.DIRECTION.HORIZONTAL &&
                (this.point1.setX(e * this.firstLineLength),
                this.point2.setX(-1 * e * (1 - this.firstLineLength)),
                this.point1.setY(0),
                this.point2.setY(0)),
              this.point1.computePointPosition(),
              this.point2.computePointPosition(),
              this.onPointsChangeObservable.notifyObservers();
          },
        },
        {
      ...
      _createClass(e, [
          ...
          value: function () {
            ...
            document.querySelectorAll("[" + n + "]").forEach(function (e) {
              var i = JSON.parse(e.getAttribute(n)),
                r = new FF_SVGLineSection(
                  e,
                  parseFloat(i.top),
                  parseFloat(i.bottom)
                );
              t.product.addLineComponent(r),
                t.createSectionChildPointsFromHTML(r);
            });
          },
        },
        {
          ...
          value: function (t) {
            function n(e, n) {
              t.addChildComponent(
                new FF_SVGPointRelativeToHTMLElemPercent({
                  x: parseFloat(e.x),
                  y: parseFloat(e.y),
                  parentElement: n,
        ...
        },
        {
          ...
          value: function () {
            ...
            for (var i = 2; i < e.length; i += 2) {
              ...
              r.getBottomAnchorX() &&
                o.getTopAnchorX() &&
                this.product.addLineComponent(
                  new FF_SVGSectionsAnchorsMerge({
                    topSection: r,
                    bottomSection: o,
                  }),
                  i
          ...
          value: function () {
            for (var e = this.product.getPoints(), t = 1; t < e.length; t++) {
              var n = e[t - 1],
                i = e[t];
              if (
                n.getComputedX() !== i.getComputedX() &&
                n.getComputedY() !== i.getComputedY()
              ) {
        ...
        },
        {
          ...
          value: function () {
            ...
            document.querySelectorAll("[" + n + "]").forEach(function (e) {
              var i = JSON.parse(e.getAttribute(n));
              i.additional_connections &&
                i.additional_connections.forEach(function (n) {
                  for (
                    var i = new FF_SVGPointRelativeToHTMLElemPercent({
                        parentElement: e,
                        x: parseFloat(n.x),
                        y: parseFloat(n.y),
                        drawCommand: FF_SVGPoint.DRAW_COMMANDS.LINE_TO,
                      }),
                      r = t.product.getPoints(),
                      o = 1;
                    o < r.length;
                    o++
                  ) {
                    var a = r[o - 1],
                      s = r[o],
                      l =
                        i.getComputedY() >= a.getComputedY() &&
                        i.getComputedY() <= s.getComputedY(),
                    ...
                    if (l && u) {
                      ...
                      t.product.addSecondaryLinePoints(c, i),
                        t.product.addLineComponentBeforePoint(c, s);
                      break;
                    }
                  }
                });
      ...
      _createClass(e, [
        {
          ...
          value: function () {
            ...
            this.svgElement.setAttribute("width", "".concat(e.width, "px")),
              this.svgElement.setAttribute("height", "".concat(e.height, "px")),
        ...
        },
        {
          ...
          value: function () {
            for (; this.svgElement.firstChild; )
  ...
  FF_SVGPointTestDisplay = (function () {
    function e(t) {
      var n =
        arguments.length > 1 && void 0 !== arguments[1]
          ? arguments[1]
          : FF_SVGRoot.SVG_NAMESPACE;
      _classCallCheck(this, e),
        (this.point = t),
        (this.svgNameSpace = n),
        this.point.onCoordinatesChangeObservable.addObserver(this),
        this.createPoint();
    }
    return (
      _createClass(e, [
        {
          ...
          value: function () {
            (this.svgNode = document.createElementNS(
              ...
              this.svgNode.setAttribute("fill", "rgba(255,255,255,1)"),
              this.svgNode.setAttribute("height", "6"),
              this.svgNode.setAttribute("width", "6");
          },
        },
        {
          key: "setPointPosition",
          value: function () {
            this.svgNode.setAttribute("x", this.point.getComputedX() - 3),
              this.svgNode.setAttribute("y", this.point.getComputedY() - 3);
          },
        },
        {
          key: "update",
  ...
  FF_SVGLineDisplay = (function () {
    function e(t, n) {
      ...
      _classCallCheck(this, e),
        ...
        (this.secondaryLines = []),
        (this.refreshRate = i),
        (this.onLineRedrawObservable = new FF_SVGObservable()),
        this.lineModel.onPointsChangeObservable.addObserver(this),
        this.createLine(),
        this.setPathData(),
        this.attachEvents();
    }
    return (
      _createClass(e, [
          ...
          value: function () {
            ...
            this.points.forEach(function (t) {
              ...
              window.addEventListener(
                "resize",
                this.calculateLineHeight.bind(this)
              ),
              setInterval(function () {
        ...
        },
        {
          ...
          value: function () {
            (this.pathNode = document.createElementNS(
              ...
              (this.mainLineMaskNode = document.createElementNS(
                this.svgNameSpace,
                "g"
              )),
              this.mainLineMaskNode.setAttribute("id", "line-path"),
              this.mainLineMaskNode.appendChild(this.pathNode),
              this.pathNode.setAttribute("fill", "transparent"),
              this.setStrokeWidth(),
              this.setStrokeColor(),
              this.svgRoot.addNode(this.mainLineMaskNode);
          },
        },
        {
          key: "update",
          ...
          value: function () {
            ...
            return (
              this.points.forEach(function (t, n) {
                var i =
                  0 == n ? FF_SVGPoint.DRAW_COMMANDS.MOVE_TO : t.getDrawCmd();
          ...
          value: function () {
            var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : null;
            e || (e = this.computePathData()),
              this.pathNode.setAttribute("d", e),
              this.onLineRedrawObservable.notifyObservers();
          },
        },
        {
          key: "setStrokeWidth",
        ...
        },
        {
          ...
          value: function () {
            return (
              (0 !== this.lineHeight && this.lineHeight) ||
  ...
  FF_SVGSecondaryLineDisplay = (function () {
    function e(t, n) {
      ...
      _classCallCheck(this, e),
        ...
        (this.point2 = n),
        (this.svgNameSpace = r),
        this.point1.onCoordinatesChangeObservable.addObserver(this),
        this.point2.onCoordinatesChangeObservable.addObserver(this),
        this.createLine(i);
    }
    return (
      _createClass(e, [
          ...
          value: function () {
            var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : {};
            (this.lineNode = document.createElementNS(
              this.svgNameSpace,
              "line"
            )),
              this.setLineCoordinates();
            (e = Object.assign({ strokeWidth: 0, strokeColor: "#fff" }, e)),
        ...
        },
        {
          ...
          value: function () {
            this.lineNode.setAttribute("x1", this.point1.getComputedX()),
              this.lineNode.setAttribute("x2", this.point2.getComputedX()),
              this.lineNode.setAttribute("y1", this.point1.getComputedY()),
              this.lineNode.setAttribute("y2", this.point2.getComputedY());
          },
        },
        {
          key: "update",
        ...
        },
        {
          key: "getLineLength",
          value: function () {
            return FF_SVGLineModel.pythagore(
              this.point1.getComputedX(),
              this.point2.getComputedX(),
              this.point1.getComputedY(),
              this.point2.getComputedY()
            );
          },
        },
        {
          ...
          value: function () {
            return this.point1.positionInLine
              ? this.point1.positionInLine
              : this.point2.positionInLine
              ? this.point2.positionInLine
              : null;
          },
        },
  ...
  FF_SVGLineMask = (function () {
    function e(t, n) {
      ...
      _classCallCheck(this, e),
        ...
        (this.svgNameSpace = r),
        (this.lastAnimationBreakpoint = null),
        this.lineDisplay.onLineRedrawObservable.addObserver(this),
        (this.onLineAnimationObservable = new FF_SVGObservable()),
      ...
      _createClass(e, [
        {
          key: "createMask",
          value: function () {
            (this.maskWrapper = document.createElementNS(
              this.svgNameSpace,
              "mask"
            )),
              this.maskWrapper.setAttribute("id", e.MASK_ID),
              (this.mask = document.createElementNS(this.svgNameSpace, "path")),
              this.computeMaskData(),
              this.mask.setAttribute("fill", "transparent"),
              this.mask.setAttribute("stroke", "#fff"),
              this.mask.setAttribute("stroke-width", 10),
              this.maskWrapper.appendChild(this.mask),
              this.attachMaskToLine(),
              this.setMaskDrawingPercentage(0, 0);
          },
        },
        {
          ...
          value: function () {
            ...
            this.lineDisplay
              .getNode()
              .setAttribute("mask", "url(#" + e.MASK_ID + ")");
          },
        },
        {
          key: "computeMaskData",
          value: function () {
            ...
            this.points.forEach(function (t, n) {
              var i =
                0 === n
                  ? FF_SVGPoint.DRAW_COMMANDS.MOVE_TO
                  : FF_SVGPoint.DRAW_COMMANDS.LINE_TO;
              e += " " + i + " " + t.getComputedX() + "," + t.getComputedY();
            }),
              this.mask.setAttribute("d", e),
              (this.maskPathLength = this.mask.getTotalLength()),
              this.mask.setAttribute("stroke-dasharray", this.maskPathLength);
          },
        },
        {
          key: "getNode",
        ...
        },
        {
          key: "update",
          value: function () {
            (this.points = this.lineDisplay.points),
              this.computeMaskData(),
              this.lastAnimationBreakpoint instanceof FF_SVGPoint
                ? this.drawLineToPoint(this.lastAnimationBreakpoint)
                : this.lastAnimationBreakpoint > 0
                ? this.setMaskDrawingPercentage(this.lastAnimationBreakpoint)
                : this.setMaskDrawingPercentage(0);
          },
        },
        {
          ...
          value: function () {
            ...
            var r = TweenLite.to(this.mask, n, {
              ...
              onUpdate: function (t) {
                var n =
                  e.maskPathLength -
                  parseFloat(this._targets[0].style.strokeDashoffset);
  ...
  FF_SVGLineMaskDebug = (function (e) {
    function t(e, n) {
      ...
      return (
        _classCallCheck(this, t),
        _possibleConstructorReturn(this, _getPrototypeOf(t).call(this, e, n, i))
      );
    }
    return (
      _inherits(t, FF_SVGLineMask),
      _createClass(t, [
        {
          key: "createMask",
          value: function () {
            (this.maskWrapper = document.createElementNS(
              ...
              this.maskWrapper.setAttribute("id", "masque-debug"),
              (this.mask = document.createElementNS(this.svgNameSpace, "path")),
              this.computeMaskData(),
              this.mask.setAttribute("fill", "transparent"),
              this.mask.setAttribute("stroke", "blue"),
              this.mask.setAttribute("stroke-width", 10),
              this.maskWrapper.appendChild(this.mask),
              this.attachMaskToLine(),
              this.setMaskDrawingPercentage(0, 0);
  ...
  FF_SVGSecondaryLineAnimation = (function () {
    function e(t) {
      ...
      _classCallCheck(this, e),
        ...
        (this.lineNode = this.lineDisplay.getNode()),
        (this.lineLength = this.lineDisplay.getLineLength() + 10),
        (this.lineIsVisible = !1),
        this.setupStrokeDash();
    }
    return (
      _createClass(e, [
        {
          key: "setupStrokeDash",
          value: function () {
            this.lineNode.setAttribute("stroke-dasharray", this.lineLength),
              this.lineNode.setAttribute("stroke-dashoffset", this.lineLength);
          },
        },
        {
          ...
          value: function () {
            (arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : 0) > this.lineDisplay.getPositionOnMainLine() &&
              (this.lineNode.setAttribute("stroke-dashoffset", 0),
        ...
        },
        {
          ...
          value: function (e) {
            ...
            e.drawPosition >= t
              ? this.animateInLine()
              : e.drawPosition < t && this.animateOutLine(0.1);
          },
        },
        {
          key: "animateInLine",
          value: function () {
            var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : null;
            this.lineIsVisible ||
              (e || (e = this.animationDuration),
              TweenLite.to(this.lineDisplay.getNode(), e, {
                "stroke-dashoffset": 0,
                ease: Power1.easeOut,
              }),
              (this.lineIsVisible = !0));
  ...
  FF_LineAnimationControl = (function () {
    function e(t, n) {
      ...
      _classCallCheck(this, e),
        (this.lineMask = t),
        (this.lineAnimationBreakPoints = n),
        (this.triggersDataAttribute = i || e.DEFAULT_TRIGGER_DATA_ATTRIBUTE),
        (this.debug = r),
        this.setup();
    }
    return (
      ...
      _createClass(e, [
        {
          ...
          value: function () {
            ...
            t.forEach(function (n, i) {
              ...
              var o, a, s;
              if (
                ((s = e.lineAnimationBreakPoints[n.stop_pt]),
                (o = s
                  ? function () {
                      e.lineMask.drawLineToPoint(s, n.tween_length);
                    }
                  : function () {
                      e.lineMask.setMaskDrawingPercentage(
                        n.draw_percentage,
                        n.tween_length
                      );
                    }),
                ...
                a = u
                  ? function (t) {
                      e.lineMask.drawLineToPoint(u, 0.6, Power1.easeOut);
                    }
                  : function (t) {
                      e.lineMask.setMaskDrawingPercentage(
                        l.draw_percentage,
        ...
        },
        {
          ...
          value: function () {
            var e,
              t = this;
            return Array.from(
              document.querySelectorAll("[" + this.triggersDataAttribute + "]")
            ).map(function (n) {
              return (
                (e = JSON.parse(n.getAttribute(t.triggersDataAttribute))),
                Object.assign(
                  {
                    elem: n,
                    draw_percentage: 0,
...
var chemin = "https://smartpixel.com/wp-content/themes/fatfish/";
var langue = "en";
var root = "https://smartpixel.com/";
var locale = "en-US";
(function () {
  var l = this || self,
    m = function (a, b) {
...
function separationContenu() {
  $(".contenu-typewriter").each(function () {
    var e = $(this).find("h1,h2,h4").length
      ? $(this).find("h1,h2,h4")
      : $(this);
    e.hasClass("wysiwyg") ||
      e.blast({
...
function update_nav_intra(e = !1, t = !1, n = !1) {
  function i(e) {
    ...
    $(".nav-intra li").each(function (n) {
      ...
      "removeClass" == e &&
        ($(".nav-intra").addClass("animation-en-cours"),
        setTimeout(function () {
  ...
  if ((!(isMobile || vw <= 1150) || n) && $(".nav-intra").length && e) {
    ...
    if (
      $(".nav-intra").hasClass("animated") ||
      section_courante == sections.length - 1
    ) {
      if (
        $(".nav-intra").hasClass("animated") &&
        "removeClass" == a &&
        !$(".nav-intra").hasClass("animation-en-cours")
      )
        return i(a), !1;
    } else $(".nav-intra").addClass("animated"), i(a);
    $(".nav-intra ul li.actif").removeClass("actif");
    var o = e.hasClass("fixed-wrapper")
      ? e.find("[data-scroll-identifiant]").attr("data-scroll-identifiant")
      : e.attr("data-scroll-identifiant");
    void 0 !== o &&
    0 != section_courante &&
    $(".nav-intra").find('[data-scroll-anchor="' + o + '"]').length > 0
      ? ($(".nav-intra")
          .find('[data-scroll-anchor="' + o + '"]')
          .closest("li")
          .addClass("actif"),
        history.replaceState(
          ...
          window.location.pathname +
            "#" +
            $(".nav-intra li.actif a").attr("data-scroll-anchor")
        ))
      : history.replaceState(null, "", window.location.pathname);
  }
}
function rendre_sections_fixed(e, t) {
  (e = "undefined" != typeof barba && e),
    (t = void 0 !== t && t),
    e &&
      ($(".fixed-wrapper").length &&
        $(".fixed-wrapper").find("footer").unwrap(),
      (sections = $("main section, footer")),
      (section_courante = 0),
      (ancienne_section_courante = 0),
      $("body").addClass("premier-chargement"),
      $(".animated, .actif:not(.image)").removeClass("animated actif"));
  var n = !1,
    i = $("[data-transition=wrapper]").hasClass("fixed_scroll");
  if (i)
    if (
      (sections || (sections = $("main section, footer")),
      0 == $(".fixed-wrapper").length && !isMobile && vw > 1150)
    ) {
      if (
        (sections.each(function () {
          $(this)
            .removeClass("animated actif")
            .wrap('<div class="fixed-wrapper"></div>');
        }),
        (n = !0),
        (sections = $(".fixed-wrapper")),
        t)
      ) {
        determiner_section_courante(),
          changer_section(),
          $("main .animated").removeClass("animated");
        new FF_Section_Animations(
          sections.eq(section_courante),
          !1,
          !0
        ).callAnims(),
          sections.eq(section_courante).addClass("actif"),
          playPauseVideo();
      }
    } else
      (isMobile || vw <= 1150) &&
        sections.hasClass("fixed-wrapper") &&
        (sections.each(function () {
  ...
  if (
    ...
    var a = window.location.href.slice(window.location.href.indexOf("#") + 1),
      o =
        i && vw > 1150
          ? $('[data-scroll-identifiant="' + a + '"]').parent()
          : $('[data-scroll-identifiant="' + a + '"]');
    o.length > 0
      ? changer_section(sections.index(o))
      : i
      ? n && changer_section()
      : changer_section();
  } else
...
function changer_section(e, t) {
  ...
  if (section_courante != ancienne_section_courante || n) {
    if (
      ($("body")
        .addClass("animation-en-cours")
        .removeClass("premier-chargement"),
      n)
    ) {
    ...
    o.callAnims();
    var s = 0;
    (isMobile || vw <= 1150) && (s = calculer_offset_scroll($(i))),
      n ? scrollToFF(i, 0, s) : scrollToFF(i, 1e3, s, t);
  }
  section_courante != ancienne_section_courante &&
    changer_texte_bottom_right(
      section_courante == sections.length - 1 ? "add" : "remove"
    );
}
function determiner_section_courante(e) {
  ...
  Math.floor($(window).scrollTop() + $(window).height()) >=
    Math.floor($(document).height()) - $("footer").innerHeight() / 2
    ? (section_courante = sections.length - 1)
    : sections.each(function (e, n) {
...
function actions_lors_du_defilement(e) {
  ...
  defilements.length > 149 && defilements.shift(),
    defilements.push(Math.abs(t));
  ...
  if (
    (o ||
      !$("body").hasClass("animation-en-cours") ||
      $("body").hasClass("defilement-en-deceleration") ||
      $("body").addClass("defilement-en-deceleration"),
    o ||
      (clearTimeout(defilement_en_deceleration_timeout),
      (defilement_en_deceleration_timeout = setTimeout(function () {
        return (
    ...
    !o && $("body").hasClass("defilement-en-deceleration"))
  )
    return e.preventDefault(), !1;
  if ($("body").hasClass("animation-en-cours"))
    return (
      e.preventDefault(),
  ...
  if (peut_defiler && o) {
    $("body").removeClass("defilement-en-deceleration");
    var s = sections.eq(section_courante),
      r = "";
    0 != section_courante && (r = sections.eq(section_courante - 1)),
      determiner_section_courante(l);
    var l = "haut";
    if (
      (n < 0 && (l = "bas"),
      section_courante == sections.length - 1 &&
        "" != r &&
        Math.ceil(vh) < Math.ceil(r.innerHeight()) &&
        "haut" == l)
    )
      return (
        changer_section(sections.length - 2, !0),
        $("body,html").css("overflow", "hidden"),
        e.preventDefault(),
        !1
      );
    if (vh < s.innerHeight())
      return "bas" == l
        ? Math.round($(window).scrollTop()) >=
          Math.round(s.innerHeight()) + Math.round(s.offset().top) - vh
          ? (section_suivante(),
            $("body,html").css("overflow", "hidden"),
            e.preventDefault(),
            !1)
          : ($("body,html").css("overflow", "auto"), !0)
        : s.offset().top >= $(window).scrollTop() && "haut" == l
        ? (changer_section(section_courante - 1),
          $("body,html").css("overflow", "hidden"),
          e.preventDefault(),
          !1)
        : ($("body,html").css("overflow", "auto"), !0);
    if (
      (e.preventDefault(), $("body,html").css("overflow", "hidden"), "bas" == l)
    )
      section_suivante();
    else if ("haut" == l) {
      if ($(sections[section_courante - 1]).innerHeight() > vh)
        return (
          changer_section(section_courante - 1, !0), e.preventDefault(), !1
        );
      section_precedente();
    }
  }
...
function obtenir_moyenne(e, t) {
  for (
    var n = 0, i = e.slice(Math.max(e.length - t, 1)), a = 0;
    a < i.length;
    a++
  )
    n += i[a];
...
function ajouter_ecouteur_defilement() {
  ...
  "DOMMouseScroll" == i
    ? document[e](
        t + "MozMousePixelScroll",
        actions_lors_du_defilement,
        !!n && { passive: !1 }
      )
    : document[e](t + i, actions_lors_du_defilement, !!n && { passive: !1 });
}
function changer_texte_bottom_right(e) {
  var t,
    n = $("#bottom-right .visible");
  "add" != e || n.hasClass("retour")
    ? "remove" == e &&
      n.hasClass("retour") &&
      ((t = $("#bottom-right .scrollToNext").text()), n.removeClass("retour"))
    : ((t = $("#bottom-right .returnToTop").text()), n.addClass("retour")),
    t &&
      (gsap.set(n, { transition: "none", transitionDelay: "initial" }),
      gsap.to(n, {
        opacity: 0,
        duration: 0.5,
        ease: "power1.out",
        onComplete: function () {
          n.text(t),
            gsap.to(n, {
              ...
              ease: "power1.out",
              onComplete: function () {
                gsap.set(n, { transition: "", transitionDelay: "" });
              },
            });
        },
      }));
...
function charger_lecteur_video(e) {
  if ($(e).closest(".apps-st").length > 0 && (isMobile || vw <= 1150))
    return !1;
  var t = !1,
    n = !1;
  $(e).closest(".showreel").length > 0 && (t = !0),
    $(e).closest(".apps-st").length > 0 &&
      (!isMobile && vw > 1150 && (n = !0),
      $(e).closest(".slide").hasClass("to-be-activated") || (t = !1));
  var i = "auto";
  $(e).closest(".showreel").length > 0 && (i = "540p"),
    $(e).closest(".apps-st").length > 0 && (i = "240p");
  var a = !0;
  ...
  var o = new Plyr($(e), {
    ...
    muted: !0,
    debug: !1,
    fullscreen: { enabled: a, iosNative: !t },
    vimeo: { textrack: "none", quality: i },
    controls: [
      "play",
      "progress",
      "current-time",
  ...
  return (
    (plyr_players[plyr_players_index] = o),
    $(o.elements.container).attr("data-plyr-player-index", plyr_players_index),
    plyr_players_index++,
    (o.loop = !0) &&
      o.on("timeupdate", function (e) {
        clearTimeout(plyrTimeOut_timeupdate),
          (plyrTimeOut_timeupdate = setTimeout(function () {
            e.detail.plyr.playing &&
              !e.detail.plyr.paused &&
              !e.detail.plyr.stopped &&
              1 == e.detail.plyr.buffered &&
              document.body.contains($(e.detail.plyr.elements.container)[0]) &&
              reinitialiser_lecteur_video(o);
          }, 1e3));
      }),
    $(e).closest(".showreel").length > 0 &&
      o.once("progress", function () {
    ...
    o.on("enterfullscreen", function () {
      $(o.elements.container)
        .find(".plyr__video-embed__container")
        .css("max-width", "100vw");
    }),
...
function reinitialiser_lecteur_video(e) {
  ...
  e.destroy(function () {
    i ||
      ((i = charger_lecteur_video($(t)[0])),
      $(i.elements.container).closest(".apps-st").length > 0 &&
        $(i.elements.container).closest(".slide").hasClass("active") &&
        i.on("ready", function () {
          i.play();
        }));
  });
...
function charger_ff_slider(e) {
  (slider = new FFSlider($(e), {
    ...
    before_slide_anim: function (e) {
      if (
        e.slider.slider.closest(".apps-st").length > 0 &&
        (vw > 750 &&
          (e.current_active_slide.find(".elems-dynam").removeClass("active"),
          e.next_active_slide.find(".elems-dynam").slideDown(600),
          e.current_active_slide.find(".elems-dynam").slideUp(600)),
        !isMobile && e.next_active_slide.find(".plyr").length > 0)
      ) {
        plyr_players[
          e.next_active_slide.find(".plyr").attr("data-plyr-player-index")
        ].play(),
          $("body").addClass("animation-en-cours");
      }
    },
    after_slide_anim: function (e) {
      if (
        e.slider.slider.closest(".apps-st").length > 0 &&
        (vw > 750 &&
          e.current_active_slide.find(".elems-dynam").addClass("active"),
        !isMobile && e.prev_active_slide.find(".plyr").length > 0)
      ) {
        plyr_players[
          e.prev_active_slide.find(".plyr").attr("data-plyr-player-index")
        ].pause(),
    ...
    after_init: function (e) {
      e.slider.slider.closest(".apps-st").length > 0 &&
        e.slider.slider &&
        ($(e.slider.elements)
          .find(".contenu-typewriter")
          .children()
          .not(".elems-dynam")
          .css("opacity", 1),
        $(e.slider.slider)
          .find(".slide.active")
          .addClass("to-be-activated")
          .removeClass("active"),
        vw > 750
          ? ($(e.slider.slider).find(".slide .elems-dynam").slideUp(0),
            $(e.slider.elements).find(".elems-dynam").slideUp(0),
            $(e.slider.slider)
              .find(".slide .elems-dynam")
              .each(function () {
                $(this).css("max-height", $(this).innerHeight());
              }))
          : $(e.slider.slider)
              .find(".slide .elems-dynam")
              .add($(e.slider.elements).find(".elems-dynam"))
              .addClass("active"));
    },
    after_slide_added: function (e) {
      isMobile ||
        (e.slider.slider.closest(".apps-st").length > 0 &&
          charger_lecteur_video(e.slide_added.find(".lecteur-video")[0])),
        vw > 750 &&
          e.slider.slider.closest(".apps-st").length > 0 &&
          $(e.slide_added)
            .find(".elems-dynam")
            .css(
              "max-height",
              $(e.slide_added).find(".elems-dynam").innerHeight()
            );
    },
    before_slide_removed: function (e) {
      if (
        !isMobile &&
        e.slider.slider.closest(".apps-st").length > 0 &&
        $(e.slide_removed).find(".plyr").length > 0
      ) {
...
function resize_page() {
  (vw = window.innerWidth),
    ...
    vw >= 1200
      ? (rem = vw / (1920 / 17)) < 14 && (rem = 14)
      : vw < 1200 && vw >= 750
      ? (rem = vw / (1024 / 14)) < 14 && (rem = 14)
      : (rem = vw / (375 / 14)) < 14 && (rem = 14),
    $("html").css("font-size", rem + "px");
}
function fix_vh() {
  isMobile || vw <= 1150
    ? ($(".intro, footer").css("min-height", $(window).innerHeight()),
      $(".back-btn-container").css("height", vh),
      $(".nav-intra").css("top", ($(window).innerHeight() / 100) * 87),
      (plyrTimeOut = clearTimeout(plyrTimeOut)),
      (plyrTimeOut = setTimeout(function () {
        $(".bloc-video").css("height", vh),
          $(".plyr__video-embed__container").css("height", vh),
          $(".plyr__poster").css("min-height", vh),
          $(".plyr__poster").css("min-width", 1.7777 * screen.height),
          $(".plyr iframe").css("min-width", 1.7777 * screen.height);
      }, 200)))
    : ($(".intro, footer").css("min-height", ""),
      $(".back-btn-container").css("height", ""),
      $(".nav-intra").css("top", ""),
      (plyrTimeOut = clearTimeout(plyrTimeOut)),
      (plyrTimeOut = setTimeout(function () {
        $(".showreel").css("height", ""),
          $(".bloc-video").css("height", ""),
          $(".plyr__video-embed__container").css("height", ""),
          $(".plyr__poster").css("min-height", ""),
          $(".plyr__poster").css("min-width", ""),
          $(".plyr iframe").css("min-width", "");
      }, 200)));
}
function placer_nav_intra_mobile() {
  var e = $("main section:first-of-type").innerHeight(),
    t = 2 * rem;
  (!isMobile && vw > 1150) || vw <= 750
    ? $(".nav-intra").css("top", "")
    : e <= vh
    ? $(".nav-intra").css("top", "")
    : $(".nav-intra").css(
        "top",
        e - t - $(".nav-intra").innerHeight() / 2 + "px"
      );
}
...
function playPauseVideo() {
  ...
  $(e).closest(".apps-st").length > 0 &&
    (e = $(sections[section_courante]).find(".slide.active .plyr").parent()),
    $.each(plyr_players, function (t, n) {
      n &&
        "" != n &&
        (e.find(n.elements.container).length
          ? (n.paused && n.play(),
            $(n.elements.container).closest(".bloc-video").length > 0 &&
              !$(n.elements.container).hasClass("muted-set") &&
              ((n.muted = !1), $(n.elements.container).addClass("muted-set")))
          : n.playing && n.pause());
    });
}
function valider_formulaire(e) {
  ...
  var n = t.find("input[type=email]"),
    i = !0;
  return (
    champs_requis.removeClass("erreur"),
    t.find(".message.erreur").remove(),
    champs_requis.each(function () {
      ("" != $(this).val() && null != $(this).val()) ||
        ($(this).addClass("erreur"), (i = !1));
    }),
    $("textarea.tinymce-enabled.erreur").prev().addClass("erreur"),
    n.each(function () {
      "" != $(this).val() &&
        (valider_courriel($(this).val()) ||
          ($(this).addClass("erreur"), (i = !1)));
    }),
    i &&
      t.hasClass("formulaire-utilisateurs") &&
      ((i = !1),
      t.addClass("chargement-en-cours"),
      t
        .find("input[type=submit]")
        .after('<span class="icone-chargement fas fa-spinner"></span>'),
      $.ajax({
        async: !0,
        url: chemin + "ajax.php",
        type: "POST",
        ...
        success: function (e) {
          t.removeClass("chargement-en-cours"),
            t.find(".icone-chargement").remove(),
            "SUCCES" == e
              ? (t.removeAttr("onsubmit"), t.submit())
              : t.prepend(e);
        },
      })),
    i && t.hasClass("ajax") && ((i = !1), envoi_du_formulaire_ajax(e)),
    i
  );
}
...
function envoi_du_formulaire_ajax(e) {
  var t = $(e),
    n = new FormData(t[0]);
  n.append("langue", langue),
    t.addClass("chargement-en-cours"),
    t
      .find(".cta")
      .after('<span class="icone-chargement fas fa-spinner"></span>'),
    t.hasClass("formulaire-carriere") &&
      n.append("formulaire-carriere", "true"),
    $.ajax({
      url: chemin + "ajax.php",
      type: "POST",
      processData: !1,
      ...
      success: function (e) {
        ...
        gsap.fromTo(
          ...
          gsap.fromTo(
            "#overlay .dots",
            { height: 0 },
            { height: i, ease: "power3.out", duration: 0.3, delay: 0.6 }
          ),
          gsap.fromTo(
            "#overlay .message",
            { y: "-1.5rem", opacity: 0 },
            { y: 0, opacity: 1, duration: 0.2, delay: 0.9, ease: "power3.out" }
          ),
          gsap.fromTo(
            "#overlay .fermer-overlay",
            { opacity: 0 },
            { opacity: 1, duration: 0.5, delay: 1.1, ease: "power1.out" }
          ),
          t.find("*[name][type!='hidden']").each(function () {
            $(this).val("");
          }),
          t.find("select option").removeAttr("selected"),
          t.find("select option:first-child").attr("selected", !0),
          t.find("*[type='checkbox']").removeAttr("checked"),
          t.find("*[type='radio']").removeAttr("checked"),
          t.find("*[type='radio']:first-child").attr("checked", !0);
      },
    });
}
function barbaAfterLeave(e) {
  return new Promise((t) => {
    if ($("#wpadminbar").length > 0) {
      var n = $(e.next.container)
          .attr("data-admin-bar-page-url")
          .replace("&amp;", "&"),
    ...
    if (
      "carriere" ==
        ("carriere" == $(e.next.container).attr("data-transition-namespace")
          ? "carriere"
          : $(e.current.container).attr("data-transition-namespace")) ||
      $(e.trigger).hasClass("langue")
    ) {
      var o = $(e.next.container.parentNode.parentNode).find("footer")[0];
      $("footer").replaceWith(o);
    } else if ($("#lecteur-video-99").length > 0) {
      var s =
        plyr_players[$("#lecteur-video-99").attr("data-plyr-player-index")]
          .elements.original;
      $("footer .plyr").replaceWith(s);
    }
    (plyr_players = []),
      $("body").removeClass("page-carriere"),
      "carriere" == $(e.next.container).attr("data-transition-namespace") &&
        $("body").addClass("page-carriere"),
      $(".overlay-header").fadeOut(0),
      calculer_tiroir();
    var r = e.next.container.parentNode.classList.value;
    $("[data-transition=wrapper]").removeClass().addClass(r), t();
  });
}
function barbaAnimationOut() {
  return new Promise((e) => {
    $("body").hasClass("tiroir-navigation-ouvert") &&
      ($("body").removeClass("tiroir-navigation-ouvert"),
      $(".overlay-header").fadeToggle(400),
      TweenMax.to("#tiroir-nav", 0.4, { x: 0 }));
    var t = new FF_Section_Animations(!1, sections.eq(section_courante), !0);
    t.allowAnimOut(),
      update_nav_intra(sections.eq(section_courante), !0),
      $("body").addClass("animation-en-cours"),
      t.callAnims().then(e);
  });
}
function barbaBeforeEnter(e) {
  return new Promise((e) => {
    ...
    $("#bottom-left .active").remove(".active"),
      $("#bottom-left").prepend(t),
      (interval = setInterval(detection_viewport, 100)),
      $(".liste-postes .description").slideUp(),
      changer_texte_bottom_right("remove"),
      $(".slider-galerie").each(function (e) {
        charger_ff_slider(this);
      }),
      $(".bloc-texte-images").each(function (e) {
        creationSlider(
          "#slider-texte-images-" + e,
          1e3,
          8e3,
          "",
          !0,
      ...
      separationContenu(),
      placer_nav_intra_mobile(),
      fix_vh(),
      setTimeout(svg_line_events_page, 10),
      e();
  });
}
function barbaEnter(e) {
  return new Promise((e) => {
    rendre_sections_fixed(!0),
      (isMobile || vw <= 1150) &&
        (determiner_section_courante(),
        update_nav_intra($(sections[section_courante]), !1, !0)),
      e();
  });
}
function barba_routing() {
  barba.hooks.after(function (e) {
    -1 == window.location.href.indexOf("fatfishweb") &&
      ("undefined" != typeof gtag
        ? gtag("config", "UA-158737805-1", { page_path: e.next.url.path })
        : "undefined" != typeof ga &&
          (ga("set", "page", e.next.url.path), ga("send", "pageview")));
  }),
    barba.init({
      timeout: 1e4,
      debug: !1,
      schema: { prefix: "data-transition" },
      transitions: [
        {
          name: "default",
          before: function (e) {
      ...
      prevent: function (e) {
        ...
        if (
          (t &&
            ...
            changer_texte_bottom_right("remove"),
            isMobile || vw <= 1150
              ? scrollToFF($("main section:first-of-type"), 1e3)
              : changer_section(0)),
          $(e.el).hasClass("ab-item") ||
            $(e.el).closest(".user_switching").length > 0)
        )
          return !0;
      },
    });
...
function rebuild_svg_line_events_page() {
  vw < 950 && $("#conteneur-ligne").hasClass("desktop")
    ? ($("#conteneur-ligne").empty(), svg_line_events_page())
    : vw > 950 &&
      $("#conteneur-ligne").hasClass("mobile") &&
      ($("#conteneur-ligne").empty(), svg_line_events_page());
}
function svg_line_events_page() {
  ...
  if (e || t) {
    var n = document.getElementById("conteneur-ligne"),
      ...
      a =
        window.innerWidth > 950
          ? svg_evenements_desktop_line_model()
          : svg_evenements_mobile_line_model(),
      o = new FF_SVGLineDisplay(a, i, 250);
    o.setStrokeColor("rgba(255,255,255,0.3)"), o.setStrokeWidth(1);
    var s = a.getSecondaryLinesPoints(),
      r = [];
    if (s.length > 0) {
      var l = document.createElementNS(FF_SVGRoot.SVG_NAMESPACE, "g");
      l.setAttribute("id", "secondary-lines-group"),
        s.forEach(function (e, t) {
          (r[t] = new FF_SVGSecondaryLineDisplay(e[0], e[1])),
            l.appendChild(r[t].getNode()),
            r[t].setStrokeColor("rgba(255,255,255,0.3)"),
            r[t].setStrokeWidth(1);
        }),
        i.addNode(l);
    }
    ...
    i.addNode(c.getNode()),
      r.forEach(function (e) {
        var t = new FF_SVGSecondaryLineAnimation(e, 0.5);
        c.onLineAnimationObservable.addObserver(t),
          t.setInitialLineVisibility(0);
      });
    new FF_LineAnimationControl(
      c,
      a.getLineAnimationStopPoints(),
      "data-line-trigger",
      !1
    );
    a.getPoints().forEach(function (e) {
      if (e instanceof FF_SVGPointRelativeToTwoPoints) {
        ...
        i.addNode(t.getNode()),
          TweenMax.set(t.getNode(), { transformOrigin: "50% 50%", scale: 0 }),
          c.onLineAnimationObservable.addObserver({
            update: function (n) {
              n.drawPosition >= e.positionInLine - 2 && !e.isVisible
                ? (TweenMax.fromTo(
                    t.getNode(),
                    0.15,
                    { scale: 0 },
                  ...
                  (e.isVisible = !0))
                : n.drawPosition < e.positionInLine - 2 &&
                  e.isVisible &&
                  (TweenMax.fromTo(
                    t.getNode(),
                    0.15,
          ...
          window.addEventListener("resize", function () {
            TweenMax.set(t.getNode(), { transformOrigin: "50% 50%" });
          });
      }
    });
  }
...
function svg_evenements_desktop_line_model() {
  ...
  return (
    ...
    e.addLineComponent(i.get("evenement-top")),
    n.forEach(function (t, a) {
      ...
      i.set(
        ...
        i.set(
          "evenement-connexion-" + a,
          new FF_SVGPointRelativeToTwoPoints({
        ...
        e.addLineComponent(i.get("evenement-connexion-" + a)),
        e.addSecondaryLinePoints(
          i.get("evenement-connexion-" + a),
          i.get("evenement-image-" + a)
        ),
        a === n.length - 1 &&
          (i.set(
            "evenement-bottom",
            new FF_SVGPointRelativeToOtherPoint({
              x: 1,
              y: 0,
  ...
  return (
    t.forEach(function (i, a) {
      ...
      n.set(
        ...
        e.addLineComponent(n.get("evenement-connexion-" + a)),
        e.addSecondaryLinePoints(
          n.get("evenement-connexion-" + a),
          n.get("evenement-image-" + a)
        ),
        a === t.length - 1 &&
          (n.set(
            "evenement-bottom",
...
var rem,
  ...
  vw,
  interval,
  ancienne_section_courante,
  sections,
  defilement_en_deceleration_timeout,
  controlTiroirs,
  plyrTimeOut,
  plyrTimeOut_timeupdate,
  plyr_players = [],
...
$(window).on("load", function () {
  resize_page(),
    ...
    fix_vh(),
    $("body").addClass("premier-chargement"),
    "carriere" == $("main").attr("data-transition-namespace") &&
      $("body").addClass("page-carriere"),
    rendre_sections_fixed(),
    (peut_defiler = !0),
    barbaBeforeEnter(),
  ...
  $(document).ready(function () {
    $(".overlay-header").fadeOut(),
      ...
      "MacIntel" === navigator.platform &&
        navigator.maxTouchPoints > 1 &&
        !window.MSStream &&
        $("body").addClass("device-ipad-ios13"),
      navigator.userAgent.indexOf("Edge") >= 0 &&
        $("body").addClass("browser-edge"),
      navigator.userAgent.indexOf("Chrome") >= 0 &&
        $("body").addClass("browser-chrome"),
      navigator.userAgent.indexOf("Silk") >= 0 &&
        $("body").addClass("browser-silk"),
      barba_routing(),
      resize_page(),
      calculer_tiroir(),
      $(window).on("resize", function () {
        ...
        if (e !== cachedWidth) {
          if (
            ...
            placer_nav_intra_mobile(),
            fix_vh(),
            rendre_sections_fixed(!1, !0),
            rebuild_svg_line_events_page(),
            $("body").hasClass("tiroir-navigation-ouvert"))
          ) {
            var t = Math.abs(parseFloat($("#tiroir-nav").css("left"))) + "px";
            TweenMax.to("#tiroir-nav", 0.4, { x: t });
          }
          cachedWidth = e;
        }
      }),
      ...
      ajouter_ecouteur_defilement(),
      $("a")
        .not(
          '[href*="' + window.location.host + '"], [href*="javascript:void(0)"]'
        )
        .click(function () {
          this.target = " _self";
        }),
      ...
      (controlTiroirs = {
        ouvrirNav: function () {
          ...
          TweenMax.to("#tiroir-nav", 0.4, { x: e });
        },
        fermerNav: function () {
          $("body").hasClass("tiroir-navigation-ouvert") &&
            ($("body").removeClass("tiroir-navigation-ouvert"),
        ...
        toggleOverlay: function () {
          if (
            $("body").hasClass("tiroir-navigation-ouvert") &&
            !$(".overlay-header").hasClass("hidden")
          )
            return !1;
      ...
      $("body").on("click", '[href*="#contact"]', function (e) {
        var t = $(this)
          .attr("href")
          .substr(0, $(this).attr("href").indexOf("#contact"));
      ...
      $("body").on("click", "#menu-mobile-contact", function () {
        controlTiroirs.fermerNav(),
          controlTiroirs.toggleOverlay(),
          changer_section(sections.length - 1);
      }),
      ...
      $("body").on("click", "#bottom-right", function () {
        $("body").hasClass("animation-en-cours") ||
          changer_section(
            section_courante < sections.length - 1 ? section_courante + 1 : 0
          );
      }),
    ...
    $("body").hasClass("device-ios")
      ...
      $("body").on("click", ".nav-intra a", function (e) {
        ...
        changer_section(
          !$('[data-transition="wrapper"]').hasClass("fixed_scroll") &&
            n.length > 0
            ? n.index("section")
            : $(this).parent().index() + 1
        );
      ...
      $("body").on("click", ".cta-accordeon", function () {
        ...
        $(".postes-row").not(e).find(".description").slideUp(300),
          e.find(".description").slideToggle(300);
      }),
      !isMobile && vw > 1150 && bodyScrollLock.disableBodyScroll(),
      isMobile &&
        $(document).on(
          "scroll",
      ...
      $(window).on("keydown", function (e) {
        if (vw <= 1150) return !0;
        $("[data-transition=wrapper]").hasClass("full_scroll") &&
          (("38" != e.keyCode && "33" != e.keyCode) || 0 == section_courante
            ? ("40" != e.keyCode && "34" != e.keyCode && "32" != e.keyCode) ||
              section_courante == sections.length - 1 ||
              (e.preventDefault(), changer_section(section_courante + 1))
            : (e.preventDefault(), changer_section(section_courante - 1)));
      });
...
class FF_Section_Animations {
  constructor(e, t = !1, n = !1) {
    (this.objIn = e),
      ...
      (this.locked = n),
      (this.delay = 0),
      (this.typewriterVitesse = 40),
      (this.vitesseFullScroll = 1e3 / this.typewriterVitesse),
      (this.blockAnims = !1),
      (this.premierChargement = !1),
      (this.allowOut = !1),
      $("[data-transition=wrapper]").hasClass("full_scroll") &&
      !isMobile &&
      vw > 1150
        ? ((this.scrollType = "full"), (this.delay = this.vitesseFullScroll))
        : $("[data-transition=wrapper]").hasClass("fixed_scroll") &&
          !isMobile &&
          vw > 1150
  ...
  detectAnims(e) {
    if (!e) return !1;
    (this.tabElements = []), this.tabElements.push(["h3", "p", "li", ".cta"]);
    var t = $.map(sections, function (t, n) {
      if (t == e[0]) return n;
    });
    e.hasClass("bloc-equipe")
      ? this.tabElements[0].push(".membre")
      : e.hasClass("bloc-liste-logos")
      ? this.tabElements[0].push(".logos>a")
      : e.hasClass("bloc-liste-elements")
      ? this.tabElements[0].push(".elements>div")
      : e.find(".archive-element").length
      ? this.tabElements[0].push(".archive-element")
      : e.find(".postes").length
      ? this.tabElements[0].push(".postes-header", ".postes-row")
      : t == sections.length - 1 &&
        (!isMobile && vw > 1150
          ? (this.tabElements[0].push("form>div>div", "#copyright"),
            this.tabElements.push([".succursale"]))
          : $("body").hasClass("page-carriere") && vw <= 950
          ? (this.tabElements[0].push(
              ".info-contact",
              "form>div>div",
              "#copyright"
            ),
  ...
  generalAnims(e) {
    var t = e == this.objIn ? "addClass" : "removeClass",
      ...
      s = ancienne_section_courante == sections.length - 1 && this.objOut != e;
    (this.premierChargement || this.allowOut || o || s) &&
      $(".back-btn-container")[t]("animated"),
      (jQuery.fn.reverse = [].reverse);
    var r = 0;
    $.each(this.tabElements, (a, o) => {
      (e == this.objIn
        ? e.find(o.toString())
        : e.find(o.toString()).reverse()
      ).each(function (e) {
        $(this).closest(".skip-children-general-anims").length > 0 ||
          (r++,
          setTimeout(() => {
            $(this)[t]("animated");
          }, r * n + 200),
      ...
      this.delay < i + a && (this.delay = i + a),
      "full" != this.scrollType || this.allowOut || (this.delay = 0);
  }
  callAnims() {
    return (
      !this.blockAnims &&
      new Promise((e) => {
        if (
          (("fixed" == this.scrollType || this.allowOut) &&
            this.objOut &&
            (this.typewriterAnim(this.objOut),
            this.detectAnims(this.objOut),
            this.objOut.find(".image.translateY").length > 0 &&
              (this.objIn &&
              (this.objIn.index() > this.objOut.index() ||
                section_courante == sections.length - 1)
                ? TweenMax.fromTo(
                    this.objOut.find(".image.translateY"),
                    0.45,
                    { y: "0%" },
                    { y: "-60%", opacity: 0, ease: Power1.easeIn }
                  )
                : TweenMax.fromTo(
                    this.objOut.find(".image.translateY"),
                    0.45,
            ...
            this.objOut.hasClass("apps-st") &&
              TweenMax.to(this.objOut.find(".slider-galerie"), 0.4, {
                opacity: 0,
                ease: Power2.easeIn,
              }),
            $(".conteneur-ligne").length > 0 &&
              gsap.to(".conteneur-ligne", {
                opacity: 0,
                duration: 0.4,
                ease: "power1.out",
              })),
          ("fixed" == this.scrollType || this.allowOut) &&
            $("section, .fixed-wrapper").removeClass("animated"),
          section_courante == sections.length - 1 || this.allowOut
            ? update_nav_intra(this.objIn, !0)
            : update_nav_intra(this.objIn),
          "default" == this.scrollType &&
            this.objIn &&
            (this.objIn.is("footer") || this.objIn.find("footer").length) &&
            (this.delay = 750 / this.typewriterVitesse),
          !isMobile && vw > 1150 && playPauseVideo(),
          this.objIn &&
            this.objIn.hasClass("apps-st") &&
            !isMobile &&
            vw > 1150)
        ) {
        ...
        setTimeout(() => {
          if (
            ("fixed" == this.scrollType &&
              $("section, .fixed-wrapper").removeClass("actif"),
            !isMobile && vw > 1150 && playPauseVideo(),
            this.objIn)
          ) {
            if ((update_nav_intra(this.objIn), this.objOut))
              var t = this.objOut,
                n = $.map(sections, function (e, n) {
                  if (e == t[0]) return n;
                });
            if (
              (this.objIn.find(".image.translateY").length > 0 &&
                (!isMobile && vw > 1150
                  ? (this.objOut &&
                      this.objIn.index() > this.objOut.index() &&
                      n != sections.length - 1) ||
                    ...
                    ? TweenMax.fromTo(
                        this.objIn.find(".image.translateY"),
                        0.45,
                        { y: "60%", opacity: 0 },
                        {
                          y: "0%",
                  ...
                  : this.objIn.find(".image.translateY").hasClass("animated") ||
                    (this.objIn.find(".image.translateY").addClass("animated"),
                    TweenMax.fromTo(
                      this.objIn.find(".image.translateY"),
                      0.45,
                      { x: "100%", opacity: 0 },
              ...
              TweenMax.to(this.objIn.find(".slider-galerie"), 1, {
                ...
                onComplete: function () {
                  !isMobile &&
                    vw > 1150 &&
                    (i.objIn
                      .find(".slider-galerie .lecteur-video")
                      .each(function () {
                        charger_lecteur_video(this);
                      }),
                    i.objIn.find(".slide.to-be-activated .plyr").length > 0 &&
                      plyr_players[
                        i.objIn
                          .find(".slide.to-be-activated .plyr")
                          .attr("data-plyr-player-index")
                      ].play()),
                    i.objIn
                      .find(".slide.to-be-activated")
                      .addClass("active")
                      .removeClass("to-be-activated")
                      .find(".elems-dynam")
            ...
            this.objIn.addClass("animated actif"),
              this.typewriterAnim(this.objIn),
              this.detectAnims(this.objIn);
          } else this.delay = 0;
          setTimeout(() => {
  ...
  typewriterAnim(e, t = !1) {
    ...
    var o = 0;
    e.hasClass("bloc-equipe") && (o = this.typewriterVitesse + 200),
      $.each(this.typewriterObjectList, (e, t) => {
        $.each(t, (t, n) => {
          $.each(n, (t, n) => {
            setTimeout(function () {
              n.css("opacity", a);
            }, this.typewriterVitesse * t + e * o),
              t > this.delay && (this.delay = t);
          });
        });
      });
  }
...
$.fn.isOnScreen = function () {
  ...
  return (
    ...
    (n.bottom = vw < 750 ? n.top + e.height() - 100 : n.top + e.height() - 200),
